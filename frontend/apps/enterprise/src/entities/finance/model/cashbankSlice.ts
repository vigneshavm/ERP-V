...
export const getAccounts = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
        try {
            ...
            return (response.data.data || response.data) as Account[];
        } catch (error: any) {
            const message =
...
export const getCashBankPosition = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
        try {
            ...
            return (response.data.data || response.data) as CashBankPosition;
        } catch (error: any) {
            const message =
                (error.response && error.response.data && error.response.data.message) ||
                error.message ||
...
export const getAccountLedger = createAsyncThunk(
    ...
    async ({ id, filters }: { id: string | undefined; filters: any }, thunkAPI) => {
        try {
            ...
            return (response.data.data || response.data) as LedgerData;
        } catch (error: any) {
            const message =
                (error.response && error.response.data && error.response.data.message) ||
                error.message ||
...
export const getBankSummary = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
        try {
            ...
            return (response.data.data || response.data) as BankSummary;
        } catch (error: any) {
            const message =
                (error.response && error.response.data && error.response.data.message) ||
                error.message ||
