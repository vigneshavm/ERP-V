    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 p-8 max-w-[1600px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex-[3] space-y-8">
                {/* Header Card */}
                <div className="bg-white/50 dark:bg-[var(--erp-bg)]/50 backdrop-blur-xl border-2 border-slate-100 dark:border-default rounded-[2.5rem] p-10 shadow-xl">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-muted mb-2 px-1">Fiscal Identity</label>
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center gap-3 px-4 py-3 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-card)]/50 rounded-2xl border-2 border-transparent">
                                    <FileText className="w-4 h-4 text-muted" />
                                    <span className="text-sm font-black text-main dark:text-main font-mono">{header.po_number}</span>
                                </div>
                                <div className="relative">
                                    <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" />
                                    <input 
                                        type="date" 
                                        className="w-full pl-12 pr-4 py-3 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-card)]/50 rounded-2xl border-2 border-transparent focus:border-indigo-500 transition-all font-bold text-sm"
                        ...
                        <div className="space-y-4">
                            <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-muted mb-2 px-1">Logistics & Proof</label>
                            <div className="flex flex-col gap-3">
                                <div className="relative">
                                    <Truck className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" />
                                    <input 
                                        type="date" 
                                ...
                                <div className="relative">
                                    <Paperclip className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" />
                                    <input 
                                        type="text" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white/50 dark:bg-[var(--erp-bg)]/50 backdrop-blur-xl border-2 border-slate-100 dark:border-default rounded-[2rem] p-8 shadow-lg">
                        <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-muted mb-4 flex items-center gap-2">
                             <CheckCircle2 className="w-3 h-3" /> Operational Directives
                        </label>
                        <textarea 
                            className="w-full h-32 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-card)]/50 border-none rounded-2xl p-4 text-sm font-bold focus:ring-4 focus:ring-indigo-500/10 transition-all placeholder:text-slate-300"
                ...
                <div className="flex justify-start gap-4">
                    <button 
                        ...
                        className="px-8 py-4 bg-white dark:bg-[var(--erp-bg)] border-2 border-slate-100 dark:border-default rounded-2xl text-muted font-black text-xs uppercase tracking-widest hover:bg-[var(--erp-bg-sunken)] transition-all flex items-center gap-3 shadow-lg"
                    >
            ...
            <div className="flex-1 space-y-8">
                <div className="bg-[var(--erp-bg)] dark:bg-indigo-950 text-white rounded-[2.5rem] p-10 shadow-2xl sticky top-8 flex flex-col gap-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 pb-4">
                            <div className="space-y-2">
                                ...
                                <input 
                                    type="number" 
                                    className="w-full bg-[var(--erp-bg-sunken)] border-none rounded-xl p-3 text-sm font-black text-main focus:ring-2 focus:ring-indigo-400 transition-all"
                            ...
                            <div className="space-y-2">
                                ...
                                <input 
                                    type="number" 
                                    className="w-full bg-[var(--erp-bg-sunken)] border-none rounded-xl p-3 text-sm font-black text-main focus:ring-2 focus:ring-rose-400 transition-all"
                                    value={extraDiscount}
                    ...
                    <div className="space-y-4 pt-10 border-t border-default">
                        <button 
                            onClick={() => handleSave('Draft')}
                            className="w-full py-5 bg-white text-main rounded-[1.5rem] font-black text-sm shadow-xl shadow-white/10 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 group"
