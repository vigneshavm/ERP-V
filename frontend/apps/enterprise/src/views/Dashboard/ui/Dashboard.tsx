...
const Dashboard: React.FC = () => {
  ...
  return (
    <Layout>
      <div className="space-y-5 sm:space-y-6 lg:space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1600px] mx-auto">

        {/* Header Section with Blueprint Atmosphere */}
        <div className="relative overflow-hidden glass-panel p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8 group border-t-2 border-t-primary/30">
          <div className="absolute top-0 right-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-primary/10 rounded-full blur-[120px] -mr-64 -mt-64 animate-aura opacity-50" />
          <div className="absolute bottom-0 left-0 w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] bg-accent/5 rounded-full blur-[80px] -ml-32 -mb-32 animate-aura" style={{ animationDelay: '5s' }} />
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3 sm:gap-6">
              <div className="w-10 h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-sm bg-primary/20 border border-primary/40 flex items-center justify-center glow-primary flex-shrink-0">
                <Target className="w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-primary" />
              </div>
              <div className="flex flex-col min-w-0">
                <h1 className="text-2xl sm:text-3xl lg:text-5xl font-display font-black text-main tracking-tighter uppercase mb-1 drop-shadow-sm">Mission Control</h1>
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  <span className="px-2 sm:px-3 py-1 bg-primary/20 text-primary text-[9px] sm:text-[10px] font-black uppercase rounded-sm border border-primary/30 tracking-[0.2em]">
                    {sectorName}
                  </span>
                  <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                  <span className="text-[10px] sm:text-xs font-bold text-secondary uppercase tracking-[0.2em] opacity-70">
                    {branchName} Node
                  </span>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between gap-2">
            <h2 className="text-[10px] sm:text-xs font-bold text-secondary uppercase tracking-[0.2em] opacity-60">Operational Overview</h2>
            <div className="flex items-center gap-2 sm:gap-3 glass-panel px-2 sm:px-4 py-1.5 sm:py-2 hover:border-primary/40 transition-all">
              <span className="text-[8px] sm:text-[9px] font-black text-secondary uppercase tracking-widest opacity-60 hidden sm:inline">Sync: {lastUpdate}</span>
              <div className="w-px h-3 bg-default opacity-50 hidden sm:block" />
              <RotateCcw
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
            {/* Total Revenue */}
            <div className="card-interactive p-3 sm:p-4 lg:p-6 flex flex-col justify-between min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] grad-primary border-l-4 border-l-primary group bg-card/60 backdrop-blur-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-sm bg-primary/20 flex items-center justify-center text-primary border border-primary/30 group-hover:glow-primary transition-all">
                    <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="text-[9px] sm:text-[11px] font-black text-secondary uppercase tracking-[0.1em] sm:tracking-[0.2em]">Revenue Matrix</span>
                </div>
                <div className="flex items-baseline gap-1">
                  <span className="text-xs sm:text-sm font-black text-primary opacity-50">₹</span>
                  <span className="text-xl sm:text-2xl lg:text-4xl font-display font-black text-main tracking-tighter group-hover:text-primary transition-colors">{totalRevenueLive.toLocaleString()}</span>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-10 sm:h-14 opacity-30 group-hover:opacity-60 transition-all duration-700">
            ...
            {/* Flux Inbound */}
            <div className="card-interactive p-3 sm:p-4 lg:p-6 flex flex-col justify-between min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] grad-success border-l-4 border-l-success group bg-card/60 backdrop-blur-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-sm bg-success/20 flex items-center justify-center text-success border border-success/30 group-hover:glow-success transition-all">
                    <ArrowDownLeft className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="text-[9px] sm:text-[11px] font-black text-secondary uppercase tracking-[0.1em] sm:tracking-[0.2em]">Flux Inbound</span>
                </div>
                <div className="flex items-baseline gap-1">
                  <span className="text-xs sm:text-sm font-black text-success opacity-50">₹</span>
                  <span className="text-xl sm:text-2xl lg:text-4xl font-display font-black text-main tracking-tighter group-hover:text-success transition-colors">{totalOutstandingLive.toLocaleString()}</span>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-10 sm:h-14 opacity-30 group-hover:opacity-60 transition-all duration-700">
                <ResponsiveContainer width="100%" height="100%">
            ...
            {/* Flux Outbound */}
            <div className="card-interactive p-3 sm:p-4 lg:p-6 flex flex-col justify-between min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] grad-error border-l-4 border-l-danger group bg-card/60 backdrop-blur-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-sm bg-danger/20 flex items-center justify-center text-danger border border-danger/30 group-hover:glow-error transition-all">
                    <ArrowUpRight className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="text-[9px] sm:text-[11px] font-black text-secondary uppercase tracking-[0.1em] sm:tracking-[0.2em]">Flux Outbound</span>
                </div>
                <div className="flex items-baseline gap-1">
                  <span className="text-xs sm:text-sm font-black text-danger opacity-50">₹</span>
                  <span className="text-xl sm:text-2xl lg:text-4xl font-display font-black text-main tracking-tighter group-hover:text-danger transition-colors">{totalToPay.toLocaleString()}</span>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-10 sm:h-14 opacity-30 group-hover:opacity-60 transition-all duration-700">
                <ResponsiveContainer width="100%" height="100%">
            ...
            {/* Asset Matrix */}
            <div className="card-interactive p-3 sm:p-4 lg:p-6 flex flex-col justify-between min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] grad-primary border-l-4 border-l-info group bg-card/60 backdrop-blur-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-sm bg-info/20 flex items-center justify-center text-info border border-info/30 group-hover:glow-primary transition-all">
                    <Package className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="text-[9px] sm:text-[11px] font-black text-secondary uppercase tracking-[0.1em] sm:tracking-[0.2em]">Asset Matrix</span>
                </div>
                <div className="flex items-baseline gap-1">
                  <span className="text-xs sm:text-sm font-black text-info opacity-50">₹</span>
                  <span className="text-xl sm:text-2xl lg:text-4xl font-display font-black text-main tracking-tighter group-hover:text-info transition-colors">{totalStockValueLive.toLocaleString()}</span>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-10 sm:h-14 opacity-30 group-hover:opacity-60 transition-all duration-700">
                <ResponsiveContainer width="100%" height="100%">
            ...
            {/* Liquidity Pulse */}
            <div className="card-interactive p-3 sm:p-4 lg:p-6 flex flex-col justify-between min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] grad-primary border-l-4 border-l-warning group bg-card/60 backdrop-blur-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-sm bg-warning/20 flex items-center justify-center text-warning border border-warning/30 group-hover:glow-primary transition-all">
                    <Landmark className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="text-[9px] sm:text-[11px] font-black text-secondary uppercase tracking-[0.1em] sm:tracking-[0.2em]">Liquidity Pulse</span>
                </div>
                <div className="flex items-baseline gap-1">
                  <span className="text-xs sm:text-sm font-black text-warning opacity-50">₹</span>
                  <span className="text-xl sm:text-2xl lg:text-4xl font-display font-black text-main tracking-tighter group-hover:text-warning transition-colors">{totalBalance.toLocaleString()}</span>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-10 sm:h-14 opacity-30 group-hover:opacity-60 transition-all duration-700">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
          ...
          {chartDataLive.length > 0 && (
            <div className="card-interactive p-4 sm:p-6 lg:p-8 group bg-card/60 backdrop-blur-2xl overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl -mr-32 -mt-32 animate-aura opacity-50" />
              <div className="flex items-center justify-between mb-4 sm:mb-6 lg:mb-10 relative z-10 border-b border-default pb-3 sm:pb-4">
                <div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-display font-black text-main tracking-tighter uppercase flex items-center gap-2 sm:gap-4">
                    <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-primary rounded-full shadow-[0_0_15px_rgba(var(--color-primary),0.5)]" />
                    Sales Flux
                  </h3>
                  <p className="text-[9px] sm:text-[11px] text-secondary font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] opacity-50 mt-1">Operational Revenue Matrix / 7D</p>
                </div>
              ...
              <div className="h-48 sm:h-56 lg:h-72 relative z-10">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="card-interactive p-4 sm:p-6 lg:p-8 group bg-card/60 backdrop-blur-2xl overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 sm:mb-6 lg:mb-10 relative z-10 border-b border-default pb-3 sm:pb-4">
              <div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-display font-black text-main tracking-tighter uppercase flex items-center gap-2 sm:gap-4">
                  <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-success rounded-full shadow-[0_0_15px_rgba(var(--color-success),0.5)]" />
                  Net Yield
                </h3>
                <p className="text-[9px] sm:text-[11px] text-secondary font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] opacity-50 mt-1">6-Month Profitability Hub</p>
              </div>
            </div>
            <div className="h-40 sm:h-48 lg:h-56 relative z-10">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="card-interactive p-4 sm:p-6 lg:p-8 group bg-card/60 backdrop-blur-2xl overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 sm:mb-6 lg:mb-10 relative z-10 border-b border-default pb-3 sm:pb-4">
              <div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-display font-black text-main tracking-tighter uppercase flex items-center gap-2 sm:gap-4">
                  <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-danger rounded-full shadow-[0_0_15px_rgba(var(--color-error),0.5)]" />
                  Leakage Map
                </h3>
                <p className="text-[9px] sm:text-[11px] text-secondary font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] opacity-50 mt-1">Expenditure Logic / Current Cycle</p>
              </div>
            </div>
            <div className="h-auto sm:h-48 lg:h-56 relative z-10 flex flex-col sm:flex-row items-center">
              <div className="flex-1 w-full h-48 sm:h-full">
                <ResponsiveContainer width="100%" height="100%">
                  <RechartsPieChart>
                    <Pie
              ...
              <div className="w-full sm:w-1/2 space-y-2 sm:space-y-4 mt-4 sm:mt-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="md:col-span-2 lg:col-span-2 card-interactive p-4 sm:p-6 lg:p-8 group min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] flex flex-col bg-card/60 backdrop-blur-2xl overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-6 lg:mb-10 pb-3 sm:pb-4 border-b border-default relative z-10 gap-2">
            <div>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-display font-black text-main tracking-tighter uppercase flex items-center gap-2 sm:gap-4">
                <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-accent rounded-full shadow-[0_0_15px_rgba(var(--color-accent),0.5)]" />
                Flux Log
              </h3>
              <p className="text-[9px] sm:text-[11px] text-secondary font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] opacity-50 mt-1">Real-Time Transaction Stream</p>
            </div>
            <button className="px-3 sm:px-5 py-1.5 sm:py-2 bg-accent/10 border border-accent/20 text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest hover:bg-accent hover:text-white transition-all rounded-sm whitespace-nowrap">
              Full Registry
            </button>
          </div>
          ...
          <div className="space-y-4 flex-1">
            {transactions && transactions.length > 0 ? (
              transactions.slice(0, 7).map((tx, idx) => (
                <div key={idx} className="flex items-center justify-between p-3 sm:p-4 lg:p-5 bg-surface/30 border border-default/50 rounded-sm hover:border-accent/40 hover:bg-surface/50 transition-all group/item hover:translate-x-1 duration-300">
                  <div className="flex items-center gap-3 sm:gap-5 min-w-0">
                    <div className={`w-9 h-9 sm:w-12 sm:h-12 rounded-sm flex items-center justify-center border flex-shrink-0 ${tx.type === 'INCOME' ? 'bg-success/10 border-success/30 text-success' : 'bg-danger/10 border-danger/30 text-danger'}`}>
                      {tx.type === 'INCOME' ? <ArrowDownLeft className="w-4 h-4 sm:w-6 sm:h-6" /> : <ArrowUpRight className="w-4 h-4 sm:w-6 sm:h-6" />}
                    </div>
                    <div className="min-w-0">
                      <p className="text-xs sm:text-sm font-black text-main uppercase tracking-tight truncate">{tx.description || 'System Protocol'}</p>
                  ...
                  <div className="text-right">
                    <p className={`text-sm sm:text-lg font-black tracking-tighter ${tx.type === 'INCOME' ? 'text-success' : 'text-danger'}`}>
