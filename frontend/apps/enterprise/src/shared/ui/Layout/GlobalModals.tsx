        ...
        <>
            ...
            {confirmDialog.isOpen && (
                <div className="fixed inset-0 z-[60] bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in">
                    <div className="glass-panel rounded-2xl p-6 max-w-sm w-full border border-default shadow-2xl">
                        ...
                        <div className="flex gap-3 justify-end">
                            <button
                                ...
                                className="px-4 py-2 text-secondary hover:bg-[var(--erp-bg-sunken)] rounded-lg font-bold transition-colors"
                            >
                                Cancel
                            </button>
                            <button
