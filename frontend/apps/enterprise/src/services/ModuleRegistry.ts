...
export const Modules = {
    ...
    TDSManager: () => import("../pages/Finance/Tax/TDSManager"),
    ...
    EmployeeDirectory: () => import("../pages/People/Employees/EmployeeDirectory"),
    EmployeeProfile: () => import("../pages/People/Employees/EmployeeProfile"),
    LeaveManagement: () => import("../pages/People/Employees/LeaveManagement"),
...
export const LazyModules = {
    ...
    EmployeeDirectory: lazy(Modules.EmployeeDirectory),
    EmployeeProfile: lazy(Modules.EmployeeProfile),
    LeaveManagement: lazy(Modules.LeaveManagement),
