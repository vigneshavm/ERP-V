...
const FinanceOverview: React.FC<FinanceOverviewProps> = ({ totalSales, totalExpenses, sectorLaborCost, netProfit }) => {
    ...
    return (
        <div className="bg-white dark:bg-[var(--erp-card)] rounded-3xl p-8 border border-default dark:border-default shadow-xl relative overflow-hidden group">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <h3 className="text-2xl font-black text-neutral-900 dark:text-main italic tracking-tighter">
