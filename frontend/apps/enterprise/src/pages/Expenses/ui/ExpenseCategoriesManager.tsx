            ...
            <div className="space-y-6 animate-fade-in text-neutral-900 dark:text-neutral-100 pb-12">
                    ...
                    <div className="p-6 border-b border-neutral-50 dark:border-default flex flex-col md:flex-row gap-4 items-center justify-between">
                        <div className="relative w-full md:w-96">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)]/50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-primary/20"
                                value={searchTerm}
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
                                {filteredCategories.map(cat => (
                                    <tr key={cat.id} className="group hover:bg-[var(--erp-bg-sunken)] transition-colors">
                                        <td className="p-6">
                                        ...
                                        <td className="p-6">
                                            {cat.approval_required ? (
                                                ...
                                                <span className="px-2.5 py-1 bg-[var(--erp-bg-sunken)] text-neutral-500 text-[9px] font-black rounded-lg uppercase tracking-widest">Auto-Approve</span>
                                            )}
                                        </td>
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
                        <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] w-full max-w-xl shadow-2xl overflow-hidden border border-default dark:border-default animate-in zoom-in-95 duration-200">
                            <div className="p-8 border-b border-default dark:border-default flex justify-between items-center">
                                <div>
                            ...
                            <form onSubmit={handleSave} className="p-8 space-y-6">
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            required
                                            className="w-full px-5 py-4 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary/20"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            required
                                            className="w-full px-5 py-4 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary/20 tabular-nums"
                                            placeholder="100000"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] rounded-2xl flex items-center justify-between">
                                            <div>
                                ...
                                <div className="pt-4 flex gap-4">
                                    <button
                                        ...
                                        className="flex-1 px-6 py-4 border border-default dark:border-default text-neutral-600 dark:text-neutral-300 rounded-2xl font-black text-sm hover:bg-[var(--erp-bg-sunken)] transition-all"
                                    >
                                        Cancel
                                    </button>
                                    <button
