        ...
        <Layout>
            ...
            <div className="space-y-6 animate-fade-in text-neutral-900 dark:text-neutral-100 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white dark:bg-[var(--erp-card)] p-6 rounded-[2rem] border border-default dark:border-default shadow-sm relative overflow-hidden">
                    ...
                    <div className="bg-white dark:bg-[var(--erp-card)] p-6 rounded-[2rem] border border-default dark:border-default shadow-sm">
                        ...
                        <div className="w-full h-1 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] rounded-full mt-3 overflow-hidden">
                    ...
                    <div className="bg-[var(--erp-bg)] text-main p-6 rounded-[2rem] shadow-xl border border-default relative group overflow-hidden">
                        ...
                        <h3 className="text-xs font-black italic leading-tight text-neutral-300">
                            {intelligence.upcomingDues.some((d: any) => d.status === 'OVERDUE')
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] border border-default dark:border-default shadow-sm overflow-hidden">
                            ...
                            <div className="divide-y divide-neutral-50 dark:divide-neutral-800 text-sm">
                                {(intelligence?.summaryByBranch || []).map((branch: any, idx: number) => (
                                    <div key={idx} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-[var(--erp-bg-sunken)] dark:hover:bg-[var(--erp-bg)]/50 transition-colors">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {(intelligence?.upcomingDues || []).map((due: any, idx: number) => (
                                        <div key={idx} className="bg-[var(--erp-bg-sunken)] border border-default p-5 rounded-2xl flex items-center justify-between hover:bg-white/10 transition-all">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white dark:bg-[var(--erp-card)] rounded-3xl border border-default dark:border-default p-6 shadow-sm">
                            ...
                            <div className="p-3 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] rounded-xl mb-4">
                                <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1">
                                    <span>Typical</span>
                                    <span>Current</span>
                                </div>
                                <div className="w-full h-1.5 bg-neutral-200 dark:bg-[var(--erp-card)] rounded-full flex overflow-hidden">
                                    <div className="h-full bg-neutral-400" style={{ width: '70%' }} />
                                    <div className="h-full bg-error" style={{ width: '30%' }} />
                                </div>
                            </div>
                            <button className="w-full py-3 bg-[var(--erp-bg)] text-main rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[var(--erp-card)] transition-all">
                                Initiate Audit
                            </button>
                        </div>
                        ...
                        <div className="bg-primary text-white p-6 rounded-3xl shadow-xl shadow-primary/20 relative overflow-hidden group">
                            ...
                            <button className="w-full py-3 bg-white text-primary font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-[var(--erp-bg-sunken)] transition-all">
                                View Bundle Options
                            </button>
                        </div>

                        <div className="p-5 rounded-3xl border border-default bg-[var(--erp-bg-sunken)]/50 flex items-start gap-4">
