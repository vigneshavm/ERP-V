        ...
        <Layout>
            ...
            <div className="space-y-6 animate-fade-in text-neutral-900 dark:text-neutral-100 pb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white dark:bg-[var(--erp-card)] p-5 rounded-3xl border border-default dark:border-default shadow-sm relative overflow-hidden group hover:border-primary/30 transition">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-2">
                            ...
                            <button className="px-4 py-3 bg-white dark:bg-[var(--erp-card)] border border-default dark:border-default rounded-2xl text-xs font-black flex items-center gap-2 hover:bg-[var(--erp-bg-sunken)] shadow-sm uppercase tracking-widest text-neutral-500">
                        ...
                        <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] border border-default dark:border-default overflow-hidden shadow-sm shadow-black/5">
                            <table className="w-full text-left text-sm tabular-nums">
                                ...
                                <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
                                    {sectorTx.map(t => (
                                        <tr key={t.id} className="hover:bg-[var(--erp-bg-sunken)] dark:hover:bg-neutral-700/30 transition-colors group cursor-default">
                                            <td className="p-6">
                                                <div className="font-bold text-neutral-900 dark:text-main uppercase tracking-tighter">{new Date(t.date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</div>
                                                <div className="text-[10px] text-neutral-400 font-bold">POS-{t.id}</div>
                                            </td>
                                            <td className="p-6">
                                                <span className="px-3 py-1 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] rounded-full text-[10px] font-black uppercase tracking-widest text-neutral-600 dark:text-neutral-400 group-hover:bg-primary/10 group-hover:text-primary transition-colors">
                                                    {t.category}
                                                </span>
                                            </td>
                                            <td className="p-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] border border-default dark:border-default p-8 shadow-sm flex flex-col items-center">
                            <h3 className="font-black text-neutral-900 dark:text-main mb-8 uppercase tracking-widest text-xs">Monthly Distribution</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 w-full mt-8">
                                {pieData.map((d, i) => (
                                    <div key={i} className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black text-neutral-900 dark:text-main ml-auto italic">₹{(d.value / 1000).toFixed(0)}k</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-neutral-950 text-main p-8 rounded-[2.5rem] border border-default shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="p-4 bg-[var(--erp-bg-sunken)] border border-default rounded-2xl hover:bg-white/10 transition">
