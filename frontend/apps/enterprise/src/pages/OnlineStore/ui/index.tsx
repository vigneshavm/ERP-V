                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        ...
                        {filteredProducts.length === 0 && (
                            <div className="col-span-full py-20 text-center">
                                <ShoppingCart className="w-16 h-16 text-muted mx-auto mb-4 opacity-20" />
                                <p className="text-muted font-medium text-lg">No products found matching your search.</p>
                            </div>
                        )}
                    </div>
                </main>
