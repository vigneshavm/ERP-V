...
import {
    ...
    Paperclip, FileCheck, ClipboardList, Info, ShieldCheck,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-sm border border-neutral-200 dark:border-neutral-700 hover:border-primary/50 transition-colors group">
                        ...
                        <div className="space-y-4">
                            ...
                            {supplierId && (
                                <div className="mt-4 p-4 bg-indigo-50/50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-800/50 rounded-xl animate-in fade-in slide-in-from-top-2">
                                    <div className="flex items-center justify-between mb-3">
                                        <h4 className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest flex items-center gap-1.5 italic">
                                            <ShieldCheck className="w-3 h-3" /> Supplier Intelligence
                                        </h4>
                                        <div className="flex items-center gap-1">
                                            <span className="w-1 h-1 rounded-full bg-indigo-500 animate-ping" />
                                            <span className="text-[8px] font-black text-indigo-500 uppercase tracking-tighter">Live Audit</span>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1">
                                            <p className="text-[9px] font-bold text-slate-500 uppercase tracking-tight">Discrepancy Rate</p>
                                            <div className="flex items-center gap-1.5">
                                                <span className="text-xs font-black text-slate-900 dark:text-white">1.2%</span>
                                                <TrendingDown className="w-3 h-3 text-emerald-500" />
                                            </div>
                                        </div>
                                        <div className="space-y-1 text-right">
                                            <p className="text-[9px] font-bold text-slate-500 uppercase tracking-tight">Lead Reliability</p>
                                            <div className="flex items-center justify-end gap-1.5">
                                                <span className="text-xs font-black text-slate-900 dark:text-white">98%</span>
                                                <TrendingUp className="w-3 h-3 text-emerald-500" />
                                            </div>
                                        </div>
                                        <div className="col-span-2 pt-2 border-t border-indigo-100/50 dark:border-indigo-800/30">
                                            <p className="text-[9px] font-bold text-slate-500 uppercase tracking-tight mb-1 flex items-center gap-1">
                                                <Info className="w-2.5 h-2.5" /> Credit Profile
                                            </p>
                                            <div className="flex items-center gap-2">
                                                <div className="flex-1 h-1 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                                                    <div className="h-full bg-indigo-500 w-[85%] rounded-full" />
                                                </div>
                                                <span className="text-[9px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">Healthy</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {supplierId && (
                                <div className="p-3 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl border border-emerald-100 dark:border-emerald-900/20 flex items-center gap-3 animate-fade-in mt-4">
