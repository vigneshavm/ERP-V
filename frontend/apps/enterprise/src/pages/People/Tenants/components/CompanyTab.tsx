...
export const CompanyTab: React.FC<{ newTenant: any, setNewTenant: any }> = ({ newTenant, setNewTenant }) => {
    // Defensive fallback for companyDetails
    const companyDetails = newTenant.companyDetails ?? {
        addressLine1: '', addressLine2: '', city: '', state: '', stateCode: '',
        country: 'India', pincode: '', email: '', phone: '', alternatePhone: '', website: ''
    };

    return (
        <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
            <div className="bg-[var(--erp-bg-sunken)] p-4 rounded-lg border border-default space-y-4">
                <label className="block text-xs font-bold text-muted uppercase tracking-wider mb-2">Address & Contact Details</label>

                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2">
                        <label className="block text-sm font-medium text-secondary mb-1">Company Address</label>
                        <input
                            className="w-full px-3 py-2 border border-default rounded-lg focus:ring-2 focus:ring-blue-500 outline-none mb-2"
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input
                                className="w-2/3 px-3 py-2 border border-default rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                                value={companyDetails.state}
                                onChange={e => setNewTenant({ ...newTenant, companyDetails: { ...newTenant.companyDetails, state: e.target.value } })}
                                placeholder="State"
                            />
                            <input
                                className="w-1/3 px-3 py-2 border border-default rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                    ...
                    <div>
                        ...
                        <input
                            className="w-full px-3 py-2 border border-default rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-[var(--erp-bg-sunken)]"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-secondary mb-1">Alternate Phone</label>
                        <input
                            type="tel"
                            className="w-full px-3 py-2 border border-default rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
