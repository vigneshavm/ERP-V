                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="w-8 h-8 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: newTenant.primaryColor || '#4f46e5' }}>
                                    <ShieldCheck className="w-4 h-4" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <p className="text-[10px] text-slate-400 mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
