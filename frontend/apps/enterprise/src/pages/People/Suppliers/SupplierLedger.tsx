                ...
                <div className="space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1600px] mx-auto">
                    ...
                    <div className="relative max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[var(--erp-card)] border border-default dark:border-default rounded-xl text-sm text-main dark:text-neutral-200 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500/50 outline-none shadow-sm placeholder:text-muted dark:placeholder:text-neutral-500"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredSuppliers.length === 0 ? (
                            <div className="col-span-full text-center py-20">
                                ...
                                <p className="text-[10px] text-muted dark:text-neutral-600 mt-1 uppercase tracking-wider font-bold">Try adjusting your search term</p>
                            </div>
                        ) : (
                            filteredSuppliers.map((s: any) => (
                                <button
                                    ...
                                    className="bg-white dark:bg-[var(--erp-card)] border border-default dark:border-default p-5 rounded-2xl shadow-sm hover:shadow-md hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-all text-left group relative overflow-hidden"
                                >
                                    ...
                                    <div className="flex items-center gap-4 relative z-10">
                                        <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100/50 dark:border-indigo-500/20 rounded-xl flex items-center justify-center text-indigo-500 font-black text-sm shrink-0 group-hover:bg-indigo-500 group-hover:text-main group-hover:border-indigo-500 transition-all">
                                            {s.businessName?.charAt(0)?.toUpperCase() || 'S'}
                                        </div>
                                        <div className="min-w-0 flex-1">
                                            <p className="font-bold text-main dark:text-neutral-100 text-sm truncate">{s.businessName}</p>
                                            {s.contactPersonName && (
                                                <p className="text-[10px] text-muted dark:text-neutral-500 truncate font-medium mt-0.5">{s.contactPersonName}</p>
                                            )}
                                        </div>
        ...
        <Layout>
            <div className="space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1600px] mx-auto">
                ...
                <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-sm font-bold text-muted dark:text-neutral-500">Loading Ledger...</p>
                </div>
            </div>
        </Layout>
    );
        ...
        <Layout>
            <div className="space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1600px] mx-auto">
                ...
                <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-sm font-bold text-muted dark:text-neutral-500">No Data Found</p>
                </div>
            </div>
        </Layout>
    );
    ...
    return (
        <Layout>
            <div className="space-y-8 animate-in fade-in duration-700 pb-10 max-w-[1600px] mx-auto">
                    ...
                    <div className="flex items-center gap-4">
                        {(id || selectedSupplierId) && (
                            <button
                                ...
                                className="w-9 h-9 flex items-center justify-center rounded-xl bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-card)] border border-default dark:border-default text-muted dark:text-neutral-400 hover:bg-indigo-50 hover:text-indigo-500 hover:border-indigo-200 dark:hover:bg-indigo-500/10 dark:hover:border-indigo-500/20 transition-all mr-2"
                            >
                                <ArrowLeft className="w-4 h-4" />
                            </button>
                        )}
                        <div className="flex flex-col">
                            <h1 className="text-xl font-bold text-main dark:text-neutral-100 tracking-tight">{data.supplier.businessName}</h1>
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <span className="text-[10px] font-bold text-muted dark:text-neutral-500">
                ...
                <div className="hidden print:block mt-8 pt-4 border-t border-gray-300 text-center text-xs text-muted">
