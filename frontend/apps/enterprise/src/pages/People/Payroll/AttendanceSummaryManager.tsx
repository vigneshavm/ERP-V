    ...
    return (
        <Layout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl border border-default shadow-sm">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            <Calendar size={18} className="text-muted" />
                            <select
                                className="p-2 border rounded-lg bg-[var(--erp-bg-sunken)] text-sm font-medium"
                            ...
                            <input
                                type="number"
                                className="w-24 p-2 border rounded-lg bg-[var(--erp-bg-sunken)] text-sm font-medium"
                ...
                <div className="mt-6 bg-white rounded-xl shadow-sm border border-default overflow-hidden">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="bg-[var(--erp-bg-sunken)]/50 border-b border-default text-muted">
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {Object.values(summaryData).map((record: any) => {
                                    ...
                                    return (
                                        <tr key={record.employeeId} className="hover:bg-[var(--erp-bg-sunken)]/30 transition-colors">
                                            <td className="px-6 py-4 font-medium text-main">
                                                {emp?.name}
                                                <span className="block text-xs text-muted font-normal">{emp?.role}</span>
                                            </td>
                                            <td className="px-4 py-4 text-muted">{record.totalDays}</td>
                                            <td className="px-4 py-4">
                                                <input
                                                    type="number"
                                                    value={record.workedDays}
                                                    onChange={(e) => handleUpdate(record.employeeId, 'workedDays', parseFloat(e.target.value))}
                                                    className="w-full p-2 border border-default rounded bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                                />
                                            </td>
                                            <td className="px-4 py-4">
                                                <input
                                                    ...
                                                    className="w-full p-2 border border-default rounded bg-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                                />
                                            </td>
                                            <td className="px-4 py-4">
                                                <input
                                                    ...
                                                    className="w-full p-2 border border-default rounded bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                />
                                            </td>
