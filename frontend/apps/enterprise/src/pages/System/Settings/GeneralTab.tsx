        ...
        <div className="p-6 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section>
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-slate-800 dark:text-white leading-none">Staff Management</h3>
                        <p className="text-xs text-slate-500 font-medium mt-1">Manage your workforce, create accounts, and assign branches</p>
                    </div>
                </div>
