            ...
            <div className="page-shell">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        {/* Customer Card */}
                        {invoice.customer && (
                            <div className="bg-white border border-default rounded-2xl shadow-sm overflow-hidden print:shadow-none print:border">
                                        ...
                                        <div className="flex flex-wrap gap-4 mt-2 text-sm text-secondary">
                                            {populatedInvoice.customer?.phone && (
                                                <span className="flex items-center gap-1.5">
                                                    <Phone className="w-4 h-4 text-muted" /> {populatedInvoice.customer.phone}
                                                </span>
                                            )}
                                            {populatedInvoice.customer?.email && (
                                                <span className="flex items-center gap-1.5">
                                                    <Mail className="w-4 h-4 text-muted" /> {populatedInvoice.customer.email}
                                                </span>
                                            )}
                                        </div>
                                        {populatedInvoice.customer?.address && (
                                            <p className="mt-2 text-sm text-muted flex items-start gap-1.5">
                                                <MapPin className="w-4 h-4 text-muted mt-0.5" /> {populatedInvoice.customer.address}
                                            </p>
                                        )}
                                    </div>
                                </div>
                        ...
                        {/* Invoice Items */}
                        <div className="bg-white border border-default rounded-2xl shadow-sm overflow-hidden print:shadow-none print:border">
                            <div className="bg-[var(--erp-bg-sunken)] px-6 py-3 border-b border-default flex justify-between items-center">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        {/* Quick Actions */}
                        <div className="bg-white border border-default rounded-2xl shadow-sm overflow-hidden print:hidden">
                            <div className="bg-[var(--erp-bg-sunken)] px-6 py-3 border-b border-default">
                            ...
                            <div className="p-4 space-y-2">
                                ...
                                <button
                                    onClick={handlePrint}
                                    className="w-full py-3 border border-slate-300 text-secondary rounded-xl font-medium hover:bg-[var(--erp-bg-sunken)] transition-all flex items-center justify-center gap-2"
                                >
