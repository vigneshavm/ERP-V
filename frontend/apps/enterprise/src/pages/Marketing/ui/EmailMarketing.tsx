            ...
            <Layout>
                <PageShell>
                    <div className="space-y-6">
                        <div className="flex items-center justify-between bg-white dark:bg-[var(--erp-bg)] p-4 rounded-3xl border border-default dark:border-default shadow-sm">
                            <button
                                onClick={() => setViewMode('manager')}
                                className="flex items-center gap-2 px-4 py-2 text-muted hover:text-indigo-600 font-black uppercase tracking-widest text-xs transition-colors"
                            >
        ...
        <Layout>
            <PageShell>
                <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-muted dark:text-muted mt-2 font-medium">Broadcast promotional campaigns, newsletter blasts, and festival offers to your audience.</p>
                        </div>
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-3.5 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-card)] hover:bg-slate-200 dark:hover:bg-slate-700 text-secondary dark:text-slate-200 rounded-2xl transition-all text-sm font-black ml-2 shadow-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-[var(--erp-card)] p-8 rounded-[2.5rem] border border-default dark:border-default shadow-sm overflow-hidden relative group">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-muted mb-4">Total Subscribers</p>
                ...
                <div className="bg-white dark:bg-[var(--erp-card)] p-8 rounded-[2.5rem] border border-default dark:border-default shadow-sm overflow-hidden relative group">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-muted mb-4">Avg. Open Rate</p>
                    <div className="flex items-end justify-between">
                        <div>
                ...
                <div className="bg-white dark:bg-[var(--erp-card)] p-8 rounded-[2.5rem] border border-default dark:border-default shadow-sm overflow-hidden relative group">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-muted mb-4">Avg. CTR</p>
                    <div className="flex items-end justify-between">
                        <div>
                ...
                <div className="bg-white dark:bg-[var(--erp-card)] p-8 rounded-[2.5rem] border border-default dark:border-default shadow-sm overflow-hidden relative group">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-muted mb-4">Bounce Rate</p>
                    <div className="flex items-end justify-between">
                        <div>
                            <h3 className="text-3xl font-black mb-1">0.82%</h3>
                            <p className="text-[10px] font-bold text-muted italic">Deliverability: 99.2%</p>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-[var(--erp-card)] rounded-[3rem] border border-default dark:border-default shadow-xl overflow-hidden">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="pl-11 pr-4 py-2.5 bg-white dark:bg-[var(--erp-bg)] border border-default dark:border-default rounded-xl text-xs font-bold w-full md:w-48 outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all font-medium"
                                />
                            </div>
                            <button className="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-[var(--erp-bg)] border border-default dark:border-default rounded-xl text-xs font-black uppercase text-secondary dark:text-muted scale-95 opacity-80">
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="text-left border-b border-default dark:border-default">
                                    <th className="p-6 text-[10px] font-black uppercase tracking-widest text-muted">Campaign</th>
                                    <th className="p-6 text-[10px] font-black uppercase tracking-widest text-muted text-center">Open Rate</th>
                                    <th className="p-6 text-[10px] font-black uppercase tracking-widest text-muted text-center">CTR</th>
                                        ...
                                        <td className="p-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] font-bold text-muted uppercase tracking-widest">{camp.audience}</p>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div className="p-6 bg-[var(--erp-bg-sunken)]/50 dark:bg-[var(--erp-bg)]/50 border-t border-default dark:border-default text-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-[var(--erp-bg)] dark:bg-[var(--erp-bg)] rounded-[2.5rem] p-8 text-main shadow-xl relative overflow-hidden group">
                        ...
                        <div className="space-y-4 relative z-10">
                            {[
                                ...
                                <div key={idx} className="p-4 bg-[var(--erp-bg-sunken)] border border-default rounded-2xl flex items-center justify-between group/line hover:bg-white/10 transition-colors cursor-pointer">
                                    <p className="text-xs font-medium text-muted italic">"{line}"</p>
                    ...
                    <div className="bg-indigo-600 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-4 opacity-80">
                            <Zap className="w-4 h-4 fill-current text-main" />
                        ...
                        <button className="mt-6 flex items-center gap-2 text-xs font-black uppercase tracking-widest bg-white text-indigo-600 px-6 py-3.5 rounded-2xl hover:bg-[var(--erp-bg-sunken)] active:scale-95 transition-all shadow-lg">
                    ...
                    <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] p-8 border border-default dark:border-default shadow-sm">
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-muted mb-6">Audience Growth</h4>
                        <div className="space-y-6">
                            <div>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-xs font-black text-muted">Unsubscribed</span>
                        ...
                        <button className="w-full mt-8 py-3.5 border border-default dark:border-default rounded-2xl text-[10px] font-black uppercase tracking-widest text-muted hover:text-indigo-600 hover:border-indigo-600 transition-all flex items-center justify-center gap-2">
