...
import {
    Layout as LayoutIcon, Image as ImageIcon, Type, Palette, Download,
        ...
        <div className="pb-20">
            {activeStep === 'gallery' ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {templates.map((template) => (
                            <div
                                ...
                                className="group bg-white dark:bg-[var(--erp-bg)] rounded-[2.5rem] border border-default dark:border-default p-8 hover:border-[#4F46E5] hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden"
                            >
                                <div className="aspect-video bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] rounded-3xl mb-6 flex items-center justify-center relative overflow-hidden">
                                    <LayoutIcon className="w-10 h-10 text-[#64748B] group-hover:text-[#4F46E5] transition-colors" />
                                </div>
                ...
                <div className="animate-in fade-in zoom-in duration-500 h-full flex flex-col md:flex-row gap-8">
                    {/* Editor Sidebar */}
                    <div className="w-full md:w-96 bg-white dark:bg-[var(--erp-bg)] border border-default dark:border-default rounded-[2.5rem] p-8 shadow-xl h-fit">
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full p-4 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)] border border-default dark:border-default rounded-2xl font-bold text-sm outline-none focus:ring-2 focus:ring-[#4F46E5] resize-none"
                                    rows={4}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative group cursor-pointer">
                                    ...
                                    <div className="w-full py-8 border-2 border-dashed border-default dark:border-default rounded-2xl flex flex-col items-center justify-center gap-2 text-[#64748B] group-hover:border-[#4F46E5] group-hover:bg-[#4F46E5]/5 transition-all">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-5 gap-2">
                                    {themes.map((theme) => (
                                        ...
                                        >
                                            {creative.theme === theme.name && <Check className="w-3 h-3 text-main" />}
                                        </button>
                                    ))}
                                </div>
                            </div>
                            ...
                            {isOwnerOrAdmin && (
                                <button className="w-full py-4 bg-[#4F46E5] text-main rounded-xl font-black uppercase tracking-widest text-xs hover:scale-105 transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#4F46E5]/30">
                    ...
                    {/* Preview Area */}
                    <div className="flex-1 bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)]/50 rounded-[3rem] p-8 flex items-center justify-center border border-default dark:border-default">
                        <div className={`relative w-full max-w-md shadow-2xl rounded-[2rem] overflow-hidden transition-all duration-300 ${formatStyles[creative.format as keyof typeof formatStyles]}`}>
                            <div className="absolute inset-0" style={{ background: `linear-gradient(135deg, ${currentTheme.colors[0]}, ${currentTheme.colors[1]})` }}>
                                <div className="h-full flex flex-col p-8 relative z-10 text-main">
