        ...
        <Layout>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                <div>
                    ...
                    <p className="text-muted dark:text-muted mt-2 font-medium">Engineer high-converting deals with AI-powered margin optimization.</p>
                </div>
                ...
                {[
                    ...
                    <div key={idx} className="bg-white dark:bg-[var(--erp-card)] p-8 rounded-[2.5rem] border border-default dark:border-default shadow-sm relative group overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                            ...
                            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)]/50 ${kpi.color}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white dark:bg-[var(--erp-card)] rounded-[3rem] border border-default dark:border-default shadow-xl overflow-hidden">
                        ...
                        <div className="divide-y divide-slate-50 dark:divide-slate-800/50">
                            {activeOffers.map((offer) => (
                                <div key={offer.id} className="p-8 flex items-center gap-6 group hover:bg-[var(--erp-bg-sunken)]/30 dark:hover:bg-[var(--erp-bg)]/20 transition-all">
                                    ...
                                    <div className="flex-1 space-y-2">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest ${offer.status === 'LIVE' ? 'bg-emerald-500 text-white' : 'bg-slate-200 text-secondary'}`}>
                                                {offer.status}
                                            </span>
                                        </div>
                                    ...
                                    <div className="shrink-0 flex flex-col items-end gap-3">
                                        <div className="text-right">
                                            <p className="text-[10px] font-black uppercase text-muted">ROI Index</p>
                                            <p className="text-sm font-black text-main">{offer.roi}</p>
                                        </div>
                                        <button className="p-2 text-muted hover:text-emerald-600 transition-colors">
                    ...
                    <div className="bg-[var(--erp-bg)] rounded-[2.5rem] p-10 text-main shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
                            <div className="space-y-4 max-w-sm">
                                ...
                                <p className="text-sm font-medium text-muted italic">Push your active offers to Social, Email, and WhatsApp in a single synchronized strike.</p>
                            </div>

                            <div className="flex flex-wrap items-center gap-4">
                                {['Instagram', 'Facebook', 'WhatsApp', 'Email'].map((ch) => (
                                    <div key={ch} className="px-5 py-3 bg-[var(--erp-bg-sunken)] border border-default rounded-2xl flex items-center gap-3 group/ch hover:bg-white/10 transition-colors cursor-pointer">
                            ...
                            <button className="flex items-center gap-3 px-8 py-5 bg-white text-main rounded-3xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl active:scale-95">
                ...
                <div className="space-y-8">
                    {/* AI Margin Optimizer */}
                    <div className="bg-white dark:bg-[var(--erp-card)] rounded-[2.5rem] p-8 border border-default dark:border-default shadow-sm relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-muted">Margin Guard AI</h4>
                        </div>
                        <h3 className="text-xl font-black mb-6 tracking-tight leading-tight italic">Optimal Discount: 18%</h3>
                        <p className="text-xs font-medium text-muted dark:text-muted leading-relaxed italic mb-8">
                        ...
                        <button className="w-full py-4 bg-[var(--erp-bg)] dark:bg-white dark:text-main text-main rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[var(--erp-card)] transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="bg-[var(--erp-bg-sunken)] dark:bg-[var(--erp-bg)]/50 rounded-[2.5rem] p-8 border border-default dark:border-default">
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-muted mb-6">Upcoming Slots</h4>
                        <div className="space-y-4">
                            {[
                                { time: 'Feb 14', name: 'Valentines Bundle', status: 'Reserved' },
                                { time: 'Mar 10', name: 'Spring Refresh', status: 'Open' }
                            ].map((slot, idx) => (
                                <div key={idx} className="p-4 bg-white dark:bg-[var(--erp-card)] rounded-2xl border border-default dark:border-default flex items-center justify-between group cursor-pointer hover:border-emerald-500/50 transition-all">
                                    <div>
                                        <p className="text-[9px] font-black text-muted uppercase tracking-widest">{slot.time}</p>
                        ...
                        <button className="w-full mt-6 py-3 text-[9px] font-black uppercase tracking-widest text-muted hover:text-emerald-600 transition-colors">
