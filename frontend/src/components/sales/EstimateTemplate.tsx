    ...
    return (
        <div className="bg-white p-8 max-w-4xl mx-auto">
            ...
            <div className="flex justify-between items-start mb-8 border-b pb-4">
                <div>
                    <h1 className="text-3xl font-bold text-slate-800">ESTIMATE</h1>
                    <p className="text-slate-500 mt-1">#{estimate.estimateNo}</p>
                </div>
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
                <div>
                    <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-2">Estimate For:</h3>
                    {estimate.customer ? (
                ...
                <div className="text-right">
                    ...
                    <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-2">From:</h3>
                    <div className="text-slate-700">
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b-2 border-slate-200">
                            <th className="py-3 text-sm font-bold text-slate-600 uppercase">Item</th>
                            <th className="py-3 text-sm font-bold text-slate-600 uppercase text-right">Price</th>
                            <th className="py-3 text-sm font-bold text-slate-600 uppercase text-center">Qty</th>
                            <th className="py-3 text-sm font-bold text-slate-600 uppercase text-right">Total</th>
                        </tr>
                    </thead>
            ...
            {estimate.notes && (
                <div className="border-t pt-4">
                    <h4 className="text-sm font-bold text-slate-500 uppercase mb-2">Notes:</h4>
                    <p className="text-slate-600 text-sm whitespace-pre-wrap">{estimate.notes}</p>
                </div>
            )}
