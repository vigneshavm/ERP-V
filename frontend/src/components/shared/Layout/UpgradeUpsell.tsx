...
const UpgradeUpsell: React.FC<UpgradeUpsellProps> = ({
    ...
    return (
        <div className="h-full flex items-center justify-center p-6 bg-slate-50/50 dark:bg-slate-900/50">
            <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-sm shadow-xl shadow-primary/5 border border-slate-200 dark:border-slate-700 p-8 text-center relative overflow-hidden">
                ...
                <div className="relative">
                    <div className="w-20 h-20 bg-primary/10 dark:bg-primary/20 rounded-sm flex items-center justify-center mx-auto mb-6">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 rounded-sm p-6 mb-8 text-left border border-slate-100 dark:border-slate-800">
                    ...
                    <button
                        className="w-full bg-primary hover:bg-primary-hover text-white font-bold py-4 px-6 rounded-sm shadow-lg shadow-primary/25 transition-all flex items-center justify-center gap-2 group"
