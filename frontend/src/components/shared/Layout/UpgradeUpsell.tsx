...
const UpgradeUpsell: React.FC<UpgradeUpsellProps> = ({
    ...
    return (
        <div className="h-full flex items-center justify-center p-6 bg-neutral-50/50 dark:bg-neutral-900/50">
            <div className="max-w-md w-full bg-white dark:bg-neutral-800 rounded-sm shadow-xl shadow-primary/5 border border-neutral-200 dark:border-neutral-700 p-8 text-center relative overflow-hidden">
                ...
                <div className="relative">
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-sm p-6 mb-8 text-left border border-neutral-100 dark:border-neutral-800">
