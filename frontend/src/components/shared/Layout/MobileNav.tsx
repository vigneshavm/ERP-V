    ...
    return (
        <nav className="ui-sticky lg:hidden fixed bottom-0 left-0 w-full bg-card/80 backdrop-blur-lg border-t border-default flex justify-around items-center h-16 pb-safe">
            <button
                ...
                className={`flex flex-col items-center justify-center w-full h-full gap-1 ${activeTab === 'DASHBOARD' ? 'text-primary' : 'text-slate-400'}`}
            >
            ...
            <button
                ...
                className={`flex flex-col items-center justify-center w-full h-full gap-1 ${activeTab === 'POS' ? 'text-primary' : 'text-slate-400'}`}
            >
