            ...
            <div key={item.name} className="relative group">
              {item.submenu ? (
                <div>
                  ...
                  {/* Submenu Dropdown */}
                  <div className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedMenus[item.name] && isEffectivelyExpanded ? 'max-h-96 opacity-100 mt-1' : 'max-h-0 opacity-0'}`}>
