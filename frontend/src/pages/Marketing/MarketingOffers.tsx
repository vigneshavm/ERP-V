        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                <div>
                    <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter italic leading-none">
                        Marketing <span className="text-emerald-600 dark:text-success">Offers</span>
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    { label: 'Offer Efficiency (ROI)', value: '9.2x', icon: BarChart3, color: 'text-primary', trend: 'Optimal Margin', sub: 'Spend vs Revenue' }
                ].map((kpi, idx) => (
                    <div key={idx} className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm relative group overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                            ...
                            <div className={`w-14 h-14 rounded-sm flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 ${kpi.color}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="divide-y divide-slate-50 dark:divide-slate-800/50">
                            {activeOffers.map((offer) => (
                                <div key={offer.id} className="p-8 flex items-center gap-6 group hover:bg-slate-50/30 dark:hover:bg-slate-900/20 transition-all">
                                    <div className={`w-16 h-16 rounded-sm ${offer.bg} ${offer.color} flex items-center justify-center shrink-0 border border-current opacity-70 group-hover:scale-110 transition-transform`}>
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-success/10 rounded-full blur-[100px] -mr-32 -mt-32 group-hover:scale-125 transition-transform duration-1000" />
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                {['Instagram', 'Facebook', 'WhatsApp', 'Email'].map((ch) => (
                                    <div key={ch} className="px-5 py-3 bg-white/5 border border-white/10 rounded-sm flex items-center gap-3 group/ch hover:bg-white/10 transition-colors cursor-pointer">
                            ...
                            <button className="flex items-center gap-3 px-8 py-5 bg-white text-slate-900 rounded-sm font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl active:scale-95">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden group">
                        ...
                        <button className="w-full py-4 bg-slate-900 dark:bg-white dark:text-slate-900 text-white rounded-sm font-black text-[10px] uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 rounded-[2.5rem] p-8 border border-slate-100 dark:border-slate-800">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={idx} className="p-4 bg-white dark:bg-slate-800 rounded-sm border border-slate-100 dark:border-slate-800 flex items-center justify-between group cursor-pointer hover:border-emerald-500/50 transition-all">
                                    <div>
                                    ...
                                    <span className={`text-[8px] font-black uppercase tracking-[0.2em] ${slot.status === 'Reserved' ? 'text-primary' : 'text-success animate-pulse'}`}>
                                        {slot.status}
                                    </span>
                                </div>
                            ))}
