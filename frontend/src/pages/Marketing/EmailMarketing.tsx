        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">Broadcast promotional campaigns, newsletter blasts, and festival offers to your audience.</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-3.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-sm transition-all text-sm font-black ml-2 shadow-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden relative group">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <div className="w-12 h-12 bg-blue-50 dark:bg-blue-900/20 rounded-sm flex items-center justify-center text-blue-600">
                ...
                <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden relative group">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <div className="w-12 h-12 bg-amber-50 dark:bg-amber-900/20 rounded-sm flex items-center justify-center text-amber-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-[3rem] border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden">
                    <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-50/50 dark:bg-slate-900/50">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="inline-flex gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/20 text-primary rounded-full text-[10px] font-black uppercase tracking-widest border border-indigo-100 dark:border-indigo-900/30">
                                3 Active
                            </div>
                        </div>
                            ...
                            <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
                                {emailCampaigns.map((camp) => (
                                    <tr key={camp.id} className="group hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                                        ...
                                        <td className="p-6 text-center">
                                            <p className="font-black text-sm text-primary">{camp.ctr}</p>
                                        </td>
                    ...
                    <div className="p-6 bg-slate-50/50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 text-center">
                        <button className="text-xs font-black uppercase tracking-widest text-primary hover:text-indigo-700 transition-colors">View All Email Campaigns</button>
                    </div>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-slate-900 dark:bg-black rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden group">
                        ...
                        <div className="space-y-4 relative z-10">
                            {[
                                ...
                                <div key={idx} className="p-4 bg-white/5 border border-white/10 rounded-sm flex items-center justify-between group/line hover:bg-white/10 transition-colors cursor-pointer">
                                    <p className="text-xs font-medium text-slate-300 italic">"{line}"</p>
                                    <button className="text-primary group-hover/line:translate-x-1 transition-transform">
                    ...
                    <div className="bg-indigo-600 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden group">
                        ...
                        <button className="mt-6 flex items-center gap-2 text-xs font-black uppercase tracking-widest bg-white text-primary px-6 py-3.5 rounded-sm hover:bg-neutral-50 active:scale-95 transition-all shadow-lg">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-700 shadow-sm">
                        ...
                        <button className="w-full mt-8 py-3.5 border border-slate-200 dark:border-slate-700 rounded-sm text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-primary hover:border-indigo-600 transition-all flex items-center justify-center gap-2">
