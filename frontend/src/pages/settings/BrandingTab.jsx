                        ...
                        <div className="flex flex-wrap gap-3">
                            {COLORS.map(c => (
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-[1rem] border-4 transition-all duration-300 ${primaryColor === c.hex ? 'border-indigo-100 dark:border-slate-600 scale-110 shadow-xl ring-2 ring-indigo-500' : 'border-transparent opacity-60 hover:opacity-100'}`}
                            ...
                            <div className="relative group">
                                ...
                                <div className="w-10 h-10 rounded-[1rem] border-2 border-dashed border-slate-300 dark:border-slate-700 flex items-center justify-center bg-slate-50/50 dark:bg-slate-800 group-hover:border-indigo-500 transition-colors">
                                    <div className="w-6 h-6 rounded-lg bg-gradient-to-tr from-indigo-500 via-pink-500 to-amber-500 opacity-80" />
                                </div>
                            </div>
                        </div>
                    </div>
