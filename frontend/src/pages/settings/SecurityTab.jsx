...
import { updateItem } from '../../redux/slices/inventorySlice';

const isSecuredIdeally = () => true;
const securePassword = (p) => p;
...
const SecurityTab = ({ roles = [], permissions = {}, handlePermissionToggle }) => {
    const dispatch = useDispatch();
    const { employees } = useSelector((state) => state.labor || { employees: [] });
    ...
    const handleMigrateAll = async () => {
        ...
        for (const user of insecureUsers) {
            try {
                ...
                await updateItem('tenant_users', user.id, {
                    pin_hash: secured,
