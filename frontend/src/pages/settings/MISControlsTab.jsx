...
import { AlertTriangle, DollarSign, FileText, Shield, Info, ChevronRight, CheckCircle2 } from 'lucide-react';

const MISControlsTab = ({ misConfig, handleMisToggle, setMaxDiscountPercent }) => {
    const ControlItem = ({ k, label, desc, icon: Icon }) => (
        ...
        <div className="p-6 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <ControlItem icon={Shield} k="requireApprovalForHighDiscount" label="Supervisor Approval" desc="Flag high discounts for management sign-off" />
                </div>
            </section>
        </div>
    );
