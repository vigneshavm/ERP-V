...
const BranchSettingsTab = () => {
    const { branches } = useSelector((state) => state.tenant || { branches: [] });
        ...
        <div className="flex h-[calc(100vh-280px)] animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="w-80 shrink-0 border-r border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900/10 p-6 space-y-4 overflow-y-auto">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="p-1 px-2.5 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-[10px] font-bold hover:bg-indigo-100 transition-colors flex items-center gap-1">
