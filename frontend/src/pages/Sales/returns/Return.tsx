        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            {formData.selectedInvoice && (
              <button
                onClick={clearDraft}
                className="flex items-center gap-2 px-4 py-2 border border-default/40 text-main opacity-90 rounded-lg hover:bg-surface/40 transition-all font-medium"
              >
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-hover shadow-sm transition-all font-medium disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 mt-2 text-sm text-secondary">
                        {formData.customer.phone && (
                          <span className="flex items-center gap-1.5"><Phone className="w-4 h-4 text-secondary opacity-50" /> {formData.customer.phone}</span>
                        )}
                        {formData.customer.email && (
                          <span className="flex items-center gap-1.5"><Mail className="w-4 h-4 text-secondary opacity-50" /> {formData.customer.email}</span>
                        )}
                      </div>
                    </div>
                  </div>
                        ...
                        <tr key={index}>
                          ...
                          <td className="px-4 py-3">
                            <input
                              ...
                              className="w-20 px-2 py-1 border border-default rounded bg-card text-main focus:ring-2 focus:ring-primary focus:border-primary"
                              min="0"
                          ...
                          <td className="px-4 py-3">
                            <select
                              ...
                              className="w-32 px-2 py-1 border border-default rounded bg-card text-main focus:ring-2 focus:ring-primary focus:border-primary"
                            >
                          ...
                          <td className="px-4 py-3">
                            <select
                              ...
                              className="w-40 px-2 py-1 border border-default rounded bg-card text-main focus:ring-2 focus:ring-primary focus:border-primary"
                            >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-2 border border-default rounded-lg bg-card text-main focus:ring-2 focus:ring-primary focus:border-primary"
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel border border-indigo-100 rounded-2xl shadow-sm overflow-hidden sticky top-4">
              ...
              <div className="px-6 py-5 bg-danger text-white">
                <div className="flex justify-between items-center">
              ...
              <div className="p-6 space-y-3">
                ...
                <button
                  onClick={handleSubmit}
                  disabled={loading}
                  className="w-full py-3 bg-primary text-white rounded-xl hover:bg-primary-hover font-bold disabled:opacity-50 flex items-center justify-center gap-2 transition-all"
                >
                  <Save className="w-4 h-4" /> {loading ? "Processing..." : "Save Return"}
                </button>
                <button
                  onClick={() => navigate("/sales/returned-items")}
                  className="w-full py-3 border border-default/40 text-main opacity-90 rounded-xl hover:bg-surface/40 font-medium transition-all"
                >
                  View Returned Items
                </button>
              </div>
          ...
          <div className="bg-card rounded-xl shadow-xl max-w-4xl w-full max-h-[80vh] overflow-hidden">
            <div className="p-6 border-b">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-default rounded-lg bg-card text-main placeholder:text-muted focus:ring-2 focus:ring-primary focus:border-primary"
              />
            </div>
                ...
                <div className="space-y-3">
                  {filteredInvoices.map((invoice) => (
                    <div
                      ...
                      className="p-4 border border-default rounded-lg hover:bg-surface hover:border-primary cursor-pointer transition"
                    >
                      <div className="flex items-center justify-between">
                        <div>
