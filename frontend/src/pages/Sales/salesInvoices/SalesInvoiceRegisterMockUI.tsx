...
import salesInvoiceRegisterData from '../../../mockData/salesInvoiceRegisterData.json';
    ...
    return (
        <div className="p-6 space-y-6 h-full flex flex-col text-main animate-fade-in">
            ...
            <div className="grid grid-cols-4 gap-4">
                {salesInvoiceRegisterData.metrics.map((stat, i) => (
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-white/5 bg-white/[0.01]">
                            {salesInvoiceRegisterData.records.map((rec, i) => (
