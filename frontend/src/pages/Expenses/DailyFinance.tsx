                    ...
                    <div className="bg-[#E8F2FF]/30 dark:bg-primary/10 border border-indigo-100 dark:border-primary/20 p-5 rounded-sm flex flex-col justify-between min-h-[120px] relative overflow-hidden group">
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-[10px] font-bold text-primary dark:text-primary uppercase tracking-widest">Net Profit</span>
                            </div>
                                        ...
                                        {recentFiltered.length === 0 ? (
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="p-5 text-right">
                                                        <span className={`text-sm font-black ${netFlow >= 0 ? 'text-success' : 'text-danger'}`}>
