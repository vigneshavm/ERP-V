            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-10 space-y-10">
                ...
                <header className="flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-muted font-medium tracking-wide mt-2">Institutional fiscal and operational overview.</p>
                    </div>
                    <div className="text-right">
                        <p className="text-sm font-black text-secondary uppercase tracking-widest mb-1">Current Cycle</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 glass-panel backdrop-blur-xl border border-default rounded-3xl p-8 flex flex-col">
                        <div className="flex justify-between items-center mb-8">
                            <div>
                                <h3 className="text-sm font-black uppercase tracking-widest text-muted">Revenue Trajectory</h3>
                    ...
                    <div className="glass-panel backdrop-blur-xl border border-default rounded-3xl p-8 flex flex-col">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-sm font-black uppercase tracking-widest text-muted">System Alerts</h3>
