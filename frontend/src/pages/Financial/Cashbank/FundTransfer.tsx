        ...
        <Layout>
            <div className="space-y-6 animate-fade-in text-neutral-900 dark:text-neutral-100 pb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-primary text-white p-5 rounded-sm shadow-lg shadow-primary/20 relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {filteredBranches.map(branch => (
                                        <div key={branch.id} className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-6 shadow-sm group hover:border-primary/30 transition-all hover:scale-[1.01]">
                                            <div className="flex justify-between items-start mb-6">
                                                <div className="flex items-center gap-3">
                                                    <div className="p-2.5 bg-neutral-100 dark:bg-neutral-900 rounded-sm group-hover:text-primary transition-colors">
                                                ...
                                                <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest ${branch.health === 'EXCESS' ? 'bg-success/10 text-success' :
                                                    branch.health === 'STABLE' ? 'bg-indigo-50 text-primary' :
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-6">
                                                <div className="p-4 bg-neutral-50 dark:bg-neutral-900/50 rounded-sm">
                            ...
                            <div className="bg-neutral-900 text-white rounded-[2.5rem] p-10 border border-neutral-800 shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="relative z-10 max-w-xl">
                                    ...
                                    <div className="space-y-6 mb-10">
                                        <div className="flex gap-5 p-6 bg-white/5 border border-white/10 rounded-sm backdrop-blur-md hover:bg-white/10 transition-colors cursor-default">
                                            <div className="p-4 bg-error/20 text-error rounded-sm h-fit shadow-inner">
                                        ...
                                        <div className="flex gap-5 p-6 bg-white/5 border border-white/10 rounded-sm backdrop-blur-md hover:bg-white/10 transition-colors cursor-default">
                                            <div className="p-4 bg-success/20 text-success rounded-sm h-fit shadow-inner">
                                    ...
                                    <button className="w-full py-4 bg-primary text-white rounded-sm font-black text-sm uppercase tracking-[0.1em] shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 group/btn_exec">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-neutral-800 rounded-sm border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm shadow-black/5">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-neutral-900 rounded-sm transition hover:bg-neutral-100 dark:hover:bg-neutral-800 border border-transparent hover:border-neutral-200 dark:hover:border-neutral-700">
                                        <span className="text-xs font-bold text-neutral-700 dark:text-neutral-300">{item.name}</span>
                                        {item.status ? <Unlock className="w-3.5 h-3.5 text-success" /> : <Lock className="w-3.5 h-3.5 text-neutral-300 transition hover:text-warning" />}
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-neutral-100 dark:bg-neutral-900 p-6 rounded-sm border border-neutral-200 dark:border-neutral-800 relative overflow-hidden group shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-white dark:bg-neutral-800 rounded-sm shadow-sm border border-error/20 hover:border-error transition">
                                ...
                                <div className="p-4 bg-white dark:bg-neutral-800 rounded-sm shadow-sm border border-amber-200 hover:border-amber-500 transition">
                                    <div className="flex justify-between items-center mb-2">
