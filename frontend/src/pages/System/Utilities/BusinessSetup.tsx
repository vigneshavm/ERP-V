...
const BusinessSetup = () => {
    ...
    const completionPercentage = () => {
        const fields: (keyof BusinessSetupFormData)[] = ['businessName', 'ownerName', 'email', 'phone'];
    ...
    return (
        <Layout>
            <div className="max-w-5xl mx-auto">
                ...
                {/* Summary Card */}
                <div className="bg-gradient-to-r from-primary to-purple-600 rounded-xl p-6 mb-6 text-white shadow-lg shadow-primary/20">
                    <h3 className="text-lg font-bold mb-3 tracking-tight">Current Business Setup</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        <div className="bg-white/10 p-3 rounded-lg backdrop-blur-sm">
                            <p className="text-white/70 font-medium uppercase tracking-wider text-[10px]">Business Name</p>
                            <p className="font-bold text-base">{formData.businessName || 'Not set'}</p>
                        </div>
                        <div className="bg-white/10 p-3 rounded-lg backdrop-blur-sm">
                            <p className="text-white/70 font-medium uppercase tracking-wider text-[10px]">GST Status</p>
                            <p className="font-bold text-base">{formData.gstEnabled ? 'Enabled' : 'Disabled'}</p>
                        </div>
                        <div className="bg-white/10 p-3 rounded-lg backdrop-blur-sm">
                            <p className="text-white/70 font-medium uppercase tracking-wider text-[10px]">Financial Year</p>
                            <p className="font-bold text-base">{formData.financialYear}</p>
                        </div>
                        <div className="bg-white/10 p-3 rounded-lg backdrop-blur-sm">
                            <p className="text-white/70 font-medium uppercase tracking-wider text-[10px]">Currency</p>
                            <p className="font-bold text-base">₹ {formData.currency}</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={onSubmit}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center space-x-6">
                                ...
                                <div>
                                    ...
                                    <label
                                        htmlFor="logo-upload"
                                        className="btn-interactive px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-hover cursor-pointer inline-block transition"
                                    >
                                        Upload Logo
                                    </label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    onChange={onChange}
                                    required
                                    className="w-full px-4 py-3 bg-input border border-default rounded-lg focus:ring-2 focus:ring-primary text-main transition-all"
                            ...
                            <div>
                                <label htmlFor="ownerName" className="block text-sm font-medium text-secondary mb-2">
                                    Owner Name <span className="text-error">*</span>
                                </label>
                                <input
                                    type="text"
                                    id="ownerName"
                            ...
                            {formData.gstEnabled && (
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <label className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all ${formData.taxMode === 'inclusive' ? 'border-primary bg-primary-soft shadow-sm shadow-primary/10' : 'border-default bg-card hover:border-primary/30'}`}>
                                            <input
                                                type="radio"
                                                name="taxMode"
                                                value="inclusive"
                                            ...
                                            />
                                            <div className="ml-3">
                                                <p className="text-sm font-bold text-main">Tax Inclusive</p>
                                                <p className="text-xs text-secondary font-medium">Price includes tax</p>
                                            </div>
                                        </label>
                                        <label className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all ${formData.taxMode === 'exclusive' ? 'border-primary bg-primary-soft shadow-sm shadow-primary/10' : 'border-default bg-card hover:border-primary/30'}`}>
                                            <input
                                                type="radio"
                                                name="taxMode"
                                                value="exclusive"
                                            ...
                                            />
                                            <div className="ml-3">
                                                <p className="text-sm font-bold text-main">Tax Exclusive</p>
                                                <p className="text-xs text-secondary font-medium">Tax added separately</p>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="p-4 bg-surface rounded-lg">
                                        ...
                                        <input
                                            type="text"
                                            placeholder="INV-"
                                            className="mt-2 w-full px-3 py-2 bg-input border border-default rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-main transition-all"
                                        />
                                    </div>
                                    <div className="p-4 bg-surface rounded-lg">
                    ...
                    <div className="flex justify-end">
                        <button
                            type="submit"
                            className="px-8 py-3 bg-primary text-white rounded-lg hover:bg-primary-hover font-bold transition flex items-center space-x-2 shadow-lg shadow-primary/25 btn-interactive"
                        >
