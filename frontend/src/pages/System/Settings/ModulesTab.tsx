...
const ModulesTab: React.FC<ModulesTabProps> = ({ modules, handleModuleToggle }) => {
    const modulesList: ModuleDef[] = [
        ...
        { id: 'labor', name: 'Staff & Payroll', icon: Briefcase, desc: 'Employee attendance, payroll and permissions', color: 'orange' },
        ...
        { id: 'purchases', name: 'Purchase & AI', icon: FileText, desc: 'Smart procurement and predictive ordering', color: 'cyan' },
        { id: 'sales', name: 'Sales History', icon: History, desc: 'Comprehensive transaction logs and returns', color: 'rose' },
        { id: 'daily', name: 'Daily Tracker', icon: ClipboardList, desc: 'End-of-day reports and cash reconciliation', color: 'lime' },
        { id: 'storefront', name: 'Web Storefront', icon: Store, desc: 'E-commerce listing and online orders', color: 'pink' },
        { id: 'reports', name: 'Advanced Analytics', icon: BarChart3, desc: 'Deep-dive reports and Profit Pulse AI', color: 'slate' }
    ];
