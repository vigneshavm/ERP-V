        ...
        <div className="p-6 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {/* Tax Mode Card */}
                    <div className="lg:col-span-1 bg-slate-50/50 dark:bg-slate-800/20 border border-slate-100 dark:border-slate-800 p-6 rounded-sm space-y-6">
                        <div>
                        ...
                        <div className="p-4 bg-white/50 dark:bg-slate-900/50 rounded-sm border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="lg:col-span-2 grid md:grid-cols-2 gap-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-sm shadow-sm">
                        <div className="space-y-1">
                            <label className="block text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                                <FileText className="w-3 h-3 text-primary" /> GSTIN / VAT Number
                            </label>
                            <input
                                type="text"
                                value={gstin || ''}
                        ...
                        <div className="space-y-1">
                            <label className="block text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                                <CreditCard className="w-3 h-3 text-primary" /> Permanent Account (PAN)
                            </label>
                            <input
                                type="text"
                                value={pan || ''}
