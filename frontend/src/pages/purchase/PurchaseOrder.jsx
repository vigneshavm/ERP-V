...
import { ClipboardList, Save, ArrowRightCircle, FileText, User, Phone, X, Plus, Trash2, Package, Calculator, Clock, CheckCircle, XCircle, FileEdit, Calendar } from 'lucide-react';
...
const PurchaseOrder = () => {
    ...
    const statusConfig = {
        ...
        received: { label: 'Received', icon: Package, color: 'blue' },
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 text-sm">Create and manage purchase orders</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white text-sm font-medium rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg shadow-purple-500/25">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6">
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <h2 className="text-base font-semibold text-slate-900">PO Details</h2>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 appearance-none transition-all"
                                    >
                                    ...
                                    <div className={`absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 text-${currentStatus.color}-600`}>
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6">
                        ...
                        {formData.supplier ? (
                            ...
                            <button
                                ...
                                className="w-full px-4 py-4 border-2 border-dashed border-slate-300 rounded-xl text-slate-500 hover:border-purple-400 hover:text-purple-600 hover:bg-purple-50/50 transition-all flex items-center justify-center gap-2"
                            >
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6">
                        ...
                        <textarea
                            ...
                            rows="3"
                            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 resize-none transition-all"
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden sticky top-4">
                        ...
                        <div className="bg-gradient-to-r from-purple-500 to-indigo-500 p-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-purple-100 text-sm">Order total</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 border-b border-slate-100">
                            <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-${currentStatus.color}-50 text-${currentStatus.color}-700 border border-${currentStatus.color}-200`}>
                                <StatusIcon className="w-4 h-4" />
                                {currentStatus.label}
                            </div>
                        </div>
                        ...
                        <div className="p-5">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-7 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <button className="w-full py-3.5 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2">
                                    <ArrowRightCircle className="w-4 h-4" />
                                    Convert to Purchase
                                </button>
                                <button className="w-full py-3.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white text-sm font-medium rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2">
                                    <Save className="w-4 h-4" />
                                    Save PO
                                </button>
                            </div>
