...
const ExpenseCategoriesManager = () => {
    ...
    return (
        <Layout>
            <div className="p-6 space-y-6 animate-fade-in text-neutral-900 dark:text-neutral-100 pb-12">
                {/* Header */}
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setEditingCategory(prev => ({ ...prev, monthly_budget: Number(e.target.value) }))}
                                        />
                                    </div>
