                        ...
                        {[
                            ...
                            <div key={idx} className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className={`text-xs font-bold px-2 py-1 rounded-full ${(typeof kpi.value === 'number' && kpi.value > 0) || (typeof kpi.value === 'string' && kpi.value !== '0%') ? 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400' : 'bg-slate-100 text-slate-400'}`}>
                                        {kpi.trend}
                                    </span>
                                </div>
                                <div>
