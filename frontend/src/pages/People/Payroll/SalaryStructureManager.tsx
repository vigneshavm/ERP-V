...
import { fetchSalaryComponents, fetchSalaryStructure, saveSalaryStructure, createSalaryComponent } from '../../../redux/slices/payrollSlice';
import { Plus, Save, User, DollarSign } from 'lucide-react';
                                                ...
                                                <div className="space-y-3">
                                                    {components.filter(c => c.type === 'EARNING').map(c => (
                                                        <div key={c._id} className="flex items-center gap-4">
                                                            <div className="w-1/3 text-sm font-medium text-gray-700">{c.name}</div>
