...
const LoanAccounts: React.FC = () => {
    ...
    const [typeFilter, setTypeFilter] = useState<'all' | 'borrowed' | 'lent'>('all');
    ...
    const generateEMISchedule = (loan: Loan) => {
        const schedule = [];
    ...
    return (
        <Layout>
            ...
            <CashBankHero
                ...
                value={`${netPosition >= 0 ? '+' : ''}₹${Math.abs(netPosition).toLocaleString('en-IN')}`}
                ...
                extraActions={
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-rose-500/20 rounded-[2rem] p-6 backdrop-blur-md border border-rose-400/30">
                            ...
                            <p className="text-xs font-bold text-rose-200/70 mt-1">{borrowedCount} borrowed</p>
                        </div>
                        <div className="bg-emerald-500/20 rounded-[2rem] p-6 backdrop-blur-md border border-emerald-400/30">
                            ...
                            <p className="text-xs font-bold text-emerald-200/70 mt-1">{lentCount} lent</p>
                        </div>
                    </div>
                }
            />
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {isActive && (
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest shadow-lg hover:bg-indigo-700 transition-all font-mono"
                                                >
                                                    Pay EMI
                                                </button>
                                            )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[3rem] shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <CashBankInput label="Lender/Borrower Name" icon={User}>
                                    <input
                                        type="text"
                                ...
                                <CashBankInput label="Loan Amount (₹)" icon={IndianRupee}>
                                    <input
                                        type="number"
                                ...
                                <CashBankInput label="Interest Rate (% p.a.)" icon={Percent}>
                                    <input
                                        type="number"
                                ...
                                <CashBankInput label="Tenure (Months)" icon={Clock}>
                                    <input
                                        type="number"
                                ...
                                <CashBankInput label="Start Date" icon={Calendar}>
                                    <input
                                        type="date"
                                ...
                                <CashBankInput label="EMI Amount (₹)" icon={Banknote}>
                                    <input
                                        type="number"
                                        value={formData.emiAmount || 0}
                    ...
                    <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-[3rem] shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div className="p-8">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <CashBankInput label="Payment Date" icon={Calendar}>
                                    <input
                                        type="date"
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <select className="w-full px-4 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-sm appearance-none">
                            ...
                            <CashBankInput label="Reference / Notes" icon={Activity}>
                                <input
                                    type="text"
                                    className="w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-sm"
