    ...
    return (
        <Layout>
            ...
            <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 rounded-[3rem] p-12 mb-8 text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="lg:col-span-2">
                        ...
                        <h2 className="text-6xl font-black tracking-tighter">₹{totalValue.toLocaleString('en-IN')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {['pending', 'cleared', 'bounced'].map((status) => {
                    ...
                    <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[3rem] shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <InputWrapper label="Cheque Number" icon={FileText}>
                                    <input
                                        type="text"
                                ...
                                <InputWrapper label="Party Name" icon={User}>
                                    <input
                                        type="text"
                                ...
                                <InputWrapper label="Amount (₹)" icon={IndianRupee}>
                                    <input
                                        type="number"
