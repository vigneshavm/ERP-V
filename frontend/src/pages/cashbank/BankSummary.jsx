            ...
            <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 rounded-[3rem] p-12 mb-8 text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="lg:col-span-2">
                        ...
                        <h2 className="text-6xl font-black tracking-tighter">₹{totalBalance.toLocaleString('en-IN', { maximumFractionDigits: 0 })}</h2>
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        {['Savings', 'Current', 'Overdraft', 'Loan'].map((type) => {
                            ...
                            const percentage = totalBalance > 0 ? ((typeBalance / totalBalance) * 100).toFixed(1) : 0;
