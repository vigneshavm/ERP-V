...
const GoogleProfile: React.FC = () => {
                ...
                <div className="min-h-[85vh] flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-50/50 to-white">
                    ...
                    <div className="max-w-xl text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight italic">
                            Command Your <span className="text-primary">Search</span> Presence
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                ...
                                className="px-10 py-5 bg-indigo-600 text-white text-lg font-black uppercase tracking-[0.2em] rounded-sm hover:bg-indigo-700 transition-all shadow-2xl shadow-indigo-200 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-4"
                            >
    ...
    return (
        <Layout>
                ...
                <PageHeader
                    ...
                    actions={[
                        <button
                            key="sync"
                            onClick={handleGoogleSync}
                            className="px-6 py-3 bg-white border-2 border-indigo-100 text-indigo-700 font-black uppercase tracking-widest text-xs rounded-sm hover:bg-indigo-50 flex items-center shadow-lg transition-all active:scale-95"
                        >
                            <svg className="w-5 h-5 mr-3 text-primary animate-spin-slow" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .533 5.347.533 12S5.867 24 12.48 24c3.44 0 6.04-1.133 8.147-3.32C22.8 18.48 23.533 15.5 23.533 13.067c0-.987-.067-1.667-.187-2.147h-10.867z" />
                            </svg>
                            Sync Profile
                        </button>
            ...
            <div className="flex space-x-2 bg-gray-100/50 backdrop-blur-sm p-1.5 rounded-sm mb-10 max-w-md border border-gray-200">
                {['overview', 'reviews', 'posts'].map((tab) => (
                    <button
                        ...
                        className={`flex-1 py-3 text-xs font-black uppercase tracking-widest rounded-xl transition-all duration-300 ${activeTab === tab
                            ? 'bg-white text-primary shadow-xl border border-indigo-50'
                ...
                <>
                    ...
                    <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-purple-700 p-10 mb-12 shadow-2xl border border-white/10 group">
                        ...
                        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                            ...
                            <button className="px-8 py-4 bg-white text-primary rounded-sm text-sm font-black uppercase tracking-widest hover:bg-indigo-50 transition-all shadow-xl hover:-translate-y-1 active:scale-95 whitespace-nowrap">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-2xl">
                                <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-gradient-to-r from-gray-50 to-white">
                                    <div className="flex items-center space-x-4">
                                        <div className="p-3 bg-indigo-600 text-white rounded-sm shadow-lg ring-4 ring-indigo-50">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 bg-indigo-50 text-primary hover:bg-indigo-600 hover:text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-sm active:scale-95"
                                        >
                                    ...
                                    {isEditing ? (
                                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                            ...
                                            <div className="flex justify-end pt-6">
                                                <button
                                                    onClick={handleSave}
                                                    className="px-10 py-4 bg-gray-900 text-white rounded-sm text-xs font-black uppercase tracking-[0.2em] hover:bg-indigo-600 transition-all shadow-xl hover:-translate-y-1 active:scale-95"
                                                >
                                                    Deploy Changes
                                                </button>
                                            </div>
                                        ...
                                        <div className="space-y-10 animate-in fade-in duration-700">
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-8">
                                                <div className="col-span-full mb-4">
                                                    <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-2 leading-none">Entity Designation</p>
                                                ...
                                                <div className="p-5 bg-gray-50 rounded-sm border border-gray-100 md:col-span-2">
                                                ...
                                                <div className="p-5 bg-gray-50 rounded-sm border border-gray-100">
                                                    ...
                                                    <a href={`https://${profileData.website}`} target="_blank" rel="noreferrer" className="font-bold text-primary hover:text-indigo-800 flex items-center">
                                                        Visit Node
                                            ...
                                            <div className="p-8 bg-indigo-50/30 rounded-[2rem] border-2 border-indigo-100/50 relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                                                    <svg className="w-20 h-20 text-primary" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 10.06-11.427l.718 1.258c-4.665.901-7.112 3.036-7.332 6.393 1.13.14 2.454.912 2.454 2.88 0 2.227-1.417 3.513-3.011 3.513-1.571 0-3.006-1.317-3.006-3.756 0-2.531 1.637-4.247 3.511-4.832V1.192c-6.83 1.839-10.547 7.745-10.547 13.554V21h7.117z" /></svg>
                                                </div>
                                                <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4">Strategic Narrative</p>
                            ...
                            <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-2xl">
                                <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-gradient-to-r from-gray-50 to-white">
                                    <div className="flex items-center space-x-4">
                                        <div className="p-3 bg-purple-600 text-white rounded-sm shadow-lg ring-4 ring-purple-50">
                                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="p-8">
                                    {showHoursEditor ? (
                                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                            ...
                                            <div className="flex justify-end pt-6">
                                                <button
                                                    ...
                                                    className="px-10 py-4 bg-purple-600 text-white rounded-sm text-xs font-black uppercase tracking-[0.2em] hover:bg-purple-700 transition-all shadow-xl hover:-translate-y-1 active:scale-95"
                                                >
                                                    Sync Parameters
                                                </button>
                                            </div>
                                        ...
                                        <div className="space-y-4 animate-in fade-in duration-700">
                                            {Object.entries(hours).map(([day, time]) => (
                                                <div key={day} className="flex justify-between items-center p-4 bg-gray-50 rounded-sm border border-gray-100 hover:bg-white hover:border-purple-200 hover:shadow-lg transition-all group">
                        ...
                        <div className="lg:col-span-1 space-y-10">
                            ...
                            <div className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-500 overflow-hidden relative">
                                ...
                                <div className="flex items-center justify-between mb-8 relative z-10">
                                    ...
                                    <button className="text-primary text-[10px] font-black uppercase tracking-widest hover:underline">Full Archive</button>
                                </div>
                                        ...
                                        photos.slice(0, 4).map((photo, idx) => (
                                            <div key={idx} className="relative aspect-[4/3] group overflow-hidden rounded-[1.5rem] shadow-inner border border-gray-100">
                                                ...
                                                <div className="absolute inset-0 bg-indigo-600/40 opacity-0 group-hover:opacity-100 transition-all duration-500 backdrop-blur-sm flex items-center justify-center">
                                                    <button className="bg-white text-primary px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl transform translate-y-4 group-hover:translate-y-0 transition-transform">Preview</button>
                                                </div>
                                            </div>
                                        ))
                                    ) : (
                                ...
                                <button
                                    ...
                                    className="w-full py-4 border-2 border-dashed border-gray-200 text-gray-400 text-xs font-black uppercase tracking-widest rounded-sm hover:bg-indigo-50 hover:border-indigo-200 hover:text-primary transition-all duration-300 flex items-center justify-center gap-3 active:scale-95"
                                >
                            ...
                            <div className="bg-indigo-600 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="flex items-center space-x-4 mb-8 relative z-10">
                                    <div className="w-12 h-12 rounded-sm bg-white/10 backdrop-blur-md flex items-center justify-center text-white border border-white/20 shadow-inner">
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-white text-primary rounded-sm font-black uppercase tracking-[0.2em] shadow-xl hover:bg-gray-50 transition-all active:scale-95 text-xs relative z-10"
                                >
                                    Deploy to Network
                                </button>
                            </div>
                            ...
                            <div className="bg-gray-900 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden relative group">
                                ...
                                <div className="space-y-4 relative z-10">
                                    {[
                                        ...
                                        <button key={i} className="w-full py-4 bg-white/5 border border-white/10 text-gray-300 text-xs font-black uppercase tracking-widest rounded-sm hover:bg-white/10 hover:text-white transition-all flex items-center justify-between px-6 group/btn">
                                            {action.label}
                                            <svg className="w-4 h-4 text-gray-600 group-hover/btn:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="space-y-10">
                            {profileData.reviews?.map((review, idx) => (
                                <div key={idx} className="flex gap-6 p-8 rounded-[2rem] bg-gray-50 border border-gray-100 hover:bg-white hover:border-indigo-100 hover:shadow-2xl transition-all duration-500 group relative overflow-hidden">
                                    ...
                                    <div className="flex-shrink-0 relative z-10">
                                        <div className="w-16 h-16 rounded-sm bg-indigo-600 text-white flex items-center justify-center text-2xl font-black shadow-lg ring-4 ring-indigo-50 transform group-hover:rotate-6 transition-transform">
                                    ...
                                    <div className="flex-1 relative z-10">
                                        ...
                                        {review.reply ? (
                                            <div className="p-6 bg-indigo-50/50 rounded-sm border-2 border-indigo-100/50 relative overflow-hidden">
                                                <div className="absolute top-0 right-0 p-3 opacity-10">
                                                    <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 10.06-11.427l.718 1.258c-4.665.901-7.112 3.036-7.332 6.393 1.13.14 2.454.912 2.454 2.88 0 2.227-1.417 3.513-3.011 3.513-1.571 0-3.006-1.317-3.006-3.756 0-2.531 1.637-4.247 3.511-4.832V1.192c-6.83 1.839-10.547 7.745-10.547 13.554V21h7.117z" /></svg>
                                                </div>
                            ...
                            {(!profileData.reviews || profileData.reviews.length === 0) && (
                                <div className="text-center py-20 bg-gray-50 rounded-[2.5rem] border-2 border-dashed border-gray-200">
                                    ...
                                    <button onClick={handleGoogleSync} className="mt-6 text-primary font-black text-xs uppercase tracking-widest hover:underline">Request Global Feed Sync</button>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="space-y-10 animate-in fade-in duration-700">
                    <div className="flex justify-between items-center bg-gray-900 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mt-1">Global Communication Feed</p>
                        </div>
                        <button className="relative z-10 px-8 py-4 bg-white text-gray-900 rounded-sm text-xs font-black uppercase tracking-[0.2em] shadow-xl hover:bg-indigo-50 hover:text-primary transition-all active:scale-95">
                            Initiate Broadcast
                        </button>
                    </div>
                            ...
                            <div key={idx} className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden group hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 flex flex-col">
                                ...
                                <div className="p-8 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-auto grid grid-cols-2 gap-4 pt-6 border-t border-gray-50">
                                        <div className="p-3 bg-indigo-50 rounded-sm flex items-center justify-between group-hover:bg-indigo-600 transition-colors duration-500">
                                        ...
                                        <div className="p-3 bg-purple-50 rounded-sm flex items-center justify-between group-hover:bg-purple-600 transition-colors duration-500">
