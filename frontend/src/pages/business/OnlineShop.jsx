...
const OnlineShop = () => {
    ...
    return (
        <Layout>
            <PageHeader title="Online Store" description="Launch and manage your e-commerce business" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {plans.map((plan, idx) => (
                        ...
                        >
                            ...
                            <button className={`w-full py-3.5 rounded-xl font-bold transition-all ${plan.button} border`}>
                                Get Started
                            </button>
                        </div>
                    ))}
