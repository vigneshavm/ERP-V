...
const WhatsAppMarketing = () => {
    ...
    const columns = [
        { key: 'name', label: 'Campaign Name', sortable: true, render: (val) => <span className="font-semibold text-gray-900">{val}</span> },
        { key: 'date', label: 'Date', sortable: true, render: (val) => <span className="text-gray-500 font-medium">{val}</span> },
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-fade-in-down">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-3 pt-4 border-t border-gray-100">
                                    <button className="px-6 py-2.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 shadow-sm transition-all active:scale-95">
                                        Send Broadcast
                                    </button>
