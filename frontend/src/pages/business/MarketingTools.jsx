                                    ...
                                    {themes.map((theme) => (
                                        <button
                                            ...
                                            className={`group relative flex flex-col items-center space-y-2 p-3 rounded-xl border-2 transition-all ${selectedTheme === theme.id
                                                ? `border-${theme.name.split(' ')[1].toLowerCase()}-500 bg-gray-50 ring-1 ring-offset-2 ${theme.ring}`
                                    ...
                                    {selectedTemplate ? (
                                        <div className="w-full bg-white rounded-xl shadow-sm overflow-hidden p-4 text-center">
                                            {uploadedImage ? (
                                                ...
                                                <div className="text-6xl mb-4 animate-bounce-slow">{selectedTemplate.thumbnail}</div>
                                            )}
