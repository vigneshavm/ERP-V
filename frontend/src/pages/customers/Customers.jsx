...
const Customers = () => {
    ...
    const customersWithDuesCount = customers.filter(c => c.dues > 0).length;
    ...
    const stats = [
        ...
        { label: 'Pending Collections', value: customersWithDuesCount, icon: AlertCircle, color: 'amber', trend: 'Critical' },
                ...
                actions={
                    <>
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-400 rounded-xl text-sm font-bold shadow-sm hover:bg-amber-100 transition-all"
                        >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-3 pt-2">
                        <button
                            ...
                            className="flex-1 px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-slate-200 transition-all"
                        >
                            Abort
                        </button>
                        <button
                            onClick={() => handleDelete(deleteConfirm)}
                            className="flex-1 px-6 py-3 bg-red-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-red-700 shadow-lg shadow-red-200 dark:shadow-none transition-all"
                        >
                            Confirm
                        </button>
                    </div>
