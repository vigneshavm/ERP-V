        ...
        <Router>
          <Routes>
            ...
            <Route path="/expenses">
              ...
              <Route path="tracker" element={<ProtectedRoute><Expenses /></ProtectedRoute>} />
              <Route path="dashboard" element={<ProtectedRoute><ExpenseDashboardPage /></ProtectedRoute>} />
              <Route path="list" element={<ProtectedRoute><ExpenseListPage /></ProtectedRoute>} />
