...
export const POSCategoryBrowserModal: React.FC<POSCategoryBrowserModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-neutral-900 w-full max-w-4xl max-h-[85vh] rounded-sm shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                {/* Header */}
                    ...
                    <div className="px-6 py-4 bg-white dark:bg-neutral-900 border-b border-neutral-100 dark:border-neutral-800">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-neutral-50 dark:bg-neutral-800 border-2 border-transparent focus:border-primary rounded-sm text-neutral-800 dark:text-neutral-200 placeholder-neutral-400 transition-all outline-none"
                                value={searchQuery}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            {categories.filter(c => c !== 'All').map(cat => (
                                <button
                                    ...
                                    className="group p-6 bg-neutral-50 dark:bg-neutral-800/50 hover:bg-primary rounded-sm transition-all duration-300 flex flex-col items-center gap-4 border-2 border-transparent hover:border-primary/40 hover:shadow-xl hover:shadow-primary/20"
                                >
                                    <div className="w-16 h-16 bg-white dark:bg-neutral-700 rounded-sm flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            {filteredSubcategories.map(sub => (
                                <button
                                    ...
                                    className="p-6 bg-white dark:bg-neutral-800 border-2 border-neutral-100 dark:border-neutral-700 hover:border-primary rounded-sm transition-all flex flex-col items-center gap-3 hover:shadow-lg"
                                >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                            {filteredProducts.map(product => (
                                <button
                                    ...
                                    className={`text-left p-4 bg-neutral-50 dark:bg-neutral-800/50 hover:bg-white dark:hover:bg-neutral-800 border-2 border-transparent hover:border-primary rounded-sm transition-all flex flex-col gap-2 ${product.stockQty <= 0 ? 'opacity-50 grayscale' : ''}`}
                                >
