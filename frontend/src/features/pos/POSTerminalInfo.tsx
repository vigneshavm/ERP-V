...
export const POSTerminalInfo: React.FC<POSTerminalInfoProps> = ({
    ...
    return (
        <div className="flex items-center gap-4 px-3 py-1.5 bg-primary-soft dark:bg-slate-900 border-b border-primary/30 dark:border-slate-800 animate-in fade-in slide-in-from-top-1">
            ...
            <div className="w-px h-3 bg-primary-soft dark:bg-slate-700" />
            <div className="flex items-center gap-1.5">
