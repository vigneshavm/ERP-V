                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {filteredAccounts.map((acc) => (
                            <div
                                key={acc.account_id}
                                className={`group bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-5 transition-all hover:bg-neutral-50 dark:hover:bg-neutral-700/30 ${acc.status !== 'OK' ? 'border-l-4 border-l-error shadow-sm' : 'shadow-sm'
                                    }`}
                            >
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                    <div className="flex items-start gap-4">
                                        <div className={`p-3 rounded-xl ${acc.type === 'CASH' ? 'bg-amber-100 text-amber-600' :
                                            acc.type === 'BANK' ? 'bg-primary/10 text-primary' : 'bg-indigo-100 text-primary'
                                            }`}>
                                ...
                                <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-700 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <button className="text-[10px] font-black text-neutral-400 hover:text-primary transition-colors uppercase tracking-widest flex items-center gap-1 group/btn_tr">
                    ...
                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="mt-3 flex items-center justify-between">
                                                    ...
                                                    <button className="text-[9px] font-black text-primary hover:underline uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all hover:scale-105 active:scale-95">
                                                        Investigate
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div className="bg-neutral-950 text-white p-6 rounded-[2rem] border border-neutral-800 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <h4 className="text-xl font-black leading-tight mb-3 tracking-tight">
                                ...
                                <button className="w-full py-3 bg-primary text-white rounded-xl font-black text-[11px] uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all active:scale-95">
