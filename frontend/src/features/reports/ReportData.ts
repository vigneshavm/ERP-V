...
export const REPORT_CATALOG: ReportCategory[] = [
    ...
    },
    {
        ...
        reports: [
            { id: 'brand-wise-sales', name: 'Brand-Wise Sales', description: 'Sales performance by brand', icon: Tag, slug: 'brand-wise-sales' },
            { id: 'category-wise-sales', name: 'Category-Wise Sales', description: 'Sales distribution across categories', icon: PieChart, slug: 'category-wise-sales' },
            { id: 'counter-wise-sales', name: 'Counter-Wise Sales', description: 'Performance metric per POS counter', icon: Store, slug: 'counter-wise-sales' },
            { id: 'hourly-billing', name: 'Hourly Billing Analysis', description: 'Peak hour analysis and load trends', icon: Clock, slug: 'hourly-billing' },
        ]
    }
];
