...
const ReportsModule: React.FC = () => {
        ...
        return (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
                <button
                    ...
                    className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors text-xs font-black uppercase tracking-widest group"
                >
    ...
    const ReportCard = ({ report }: { report: ReportDefinition, key?: string }) => {
        ...
        return (
            <div
                className="group relative bg-white dark:bg-slate-900 rounded-sm p-6 border border-slate-200 dark:border-slate-800 hover:border-primary dark:hover:border-primary hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 flex flex-col h-full cursor-pointer animate-in fade-in zoom-in-95"
                onClick={() => setSelectedReportSlug(report.id)}
            >
                <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 group-hover:bg-primary group-hover:text-white transition-all duration-300 group-hover:scale-110">
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center text-[10px] font-black uppercase tracking-widest text-primary group-hover:translate-x-1 transition-transform">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative group flex-1 lg:w-72">
                            ...
                            <input
                                ...
                                className="w-full bg-white dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-800 focus:ring-2 focus:ring-primary rounded-xl py-2.5 pl-10 pr-4 text-sm transition-all shadow-sm text-slate-900 dark:text-white"
                            />
                        </div>
                    </div>
                ) : null}
            ...
            <div className="min-h-[400px]">
                {activeTab === 'custom' ? (
                    <div className="animate-in fade-in zoom-in-95 duration-700">
                        <div className="relative overflow-hidden rounded-xl bg-slate-900 border border-slate-800 p-8 lg:p-16 text-white shadow-2xl">
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                                <div className="max-w-2xl text-center lg:text-left">
                                    ...
                                    <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-4">
                                        <div className="flex items-center gap-2 px-5 py-2.5 bg-slate-800/40 rounded-sm border border-slate-700/50 text-xs font-bold text-slate-300 backdrop-blur-sm">
                                ...
                                <div className="flex-shrink-0">
                                    <button className="px-12 py-6 bg-white text-slate-900 rounded-[2.5rem] font-black uppercase tracking-widest text-sm hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-primary/10 flex items-center gap-4 group">
                                        Request Report
                        ...
                        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 opacity-40 grayscale group-hover:grayscale-0 transition-all">
                            {['Data Integrity', 'GDPR Compliant', 'Real-time Sync', 'Audit Ready'].map(badge => (
                                <div key={badge} className="flex items-center justify-center gap-2 p-4 border border-dashed border-slate-200 dark:border-slate-800 rounded-sm">
