        ...
        <div className="min-h-full bg-app text-main font-sans selection:bg-warning/10 overflow-hidden flex flex-col transition-colors animate-fade-in relative">
            ...
            <header className="relative z-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-8 py-4 flex items-center justify-between shadow-sm transition-all">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        onClick={() => navigate('/sales/challans')}
                        className="hidden md:flex items-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm"
                    >
                        Cancel
                    </button>
                    <button 
                    ...
                    <div className="max-w-[1000px] mx-auto space-y-8 pb-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                { label: 'Gross Quantity', value: metrics.totalQty, icon: Activity, color: 'text-primary' },
                                        ...
                                        {formData.items.length === 0 ? (
                                            ...
                                            formData.items.map((item, index) => (
                                                <tr key={index} className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                                    ...
                                                    <td className="px-8 py-6 text-right">
                                                        <div className="inline-flex items-center bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden p-1 shadow-inner">
                                                            <button 
                    ...
                    <div className="space-y-8">
                                ...
                                <div className="bg-white dark:bg-slate-900 border-2 border-warning/20 rounded-sm p-6 shadow-xl shadow-amber-500/5 relative overflow-hidden group transition-all hover:scale-[1.02]">
                                    ...
                                    <div className="flex items-start gap-4 mb-4 relative z-10">
                                        ...
                                        <div className="flex-1 overflow-hidden">
                                            ...
                                            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-0.5 truncate">{formData.customer.address?.line1}, {formData.customer.address?.city}</p>
                                        </div>
                                        <button 
                        ...
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px] p-6 space-y-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-5 gap-2">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`p-3 rounded-xl border transition-all flex items-center justify-center ${formData.transportMode === mode.id ? 'bg-warning border-warning text-white shadow-lg shadow-amber-500/20' : 'bg-slate-50 dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-400 hover:border-warning/30'}`}
                                ...
                                <div>
                                    <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-2">Dispatch Date</label>
                                    <div className="relative">
