        ...
        <div className="sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 py-3 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 ml-auto">
                <button
                    ...
                    className={`hidden md:flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-sm transition-all border ${showAi ? 'bg-primary text-white border-primary' : 'bg-white dark:bg-slate-800 text-primary dark:text-primary border-primary/30 dark:border-primary/30'}`}
                >
