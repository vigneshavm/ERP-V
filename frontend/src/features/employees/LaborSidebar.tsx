            ...
            <div className="flex-1 overflow-y-auto space-y-2 custom-scrollbar pr-1 -mr-2">
                {isLoading ? (
                    <div className="text-center py-8">
                        <Loader2 className="w-6 h-6 text-gray-300 dark:text-gray-600 mx-auto mb-2 animate-spin" />
                        <p className="text-xs text-gray-400 dark:text-gray-500">Loading staff…</p>
                    </div>
                ) : loadError ? (
