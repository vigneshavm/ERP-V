    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-sm border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-sm p-8 text-center hover:border-primary/50 transition-colors cursor-pointer capitalize">
                    <Plus className="w-8 h-8 text-slate-300 mx-auto mb-2" />
                    <p className="text-xs text-slate-500 font-medium">Upload Delivery Challan or Photos</p>
                </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-sm border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <textarea
                    className="w-full p-4 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-sm text-sm focus:ring-2 focus:ring-primary outline-none min-h-[120px]"
