...
const BillFinancialSummary: React.FC<BillFinancialSummaryProps> = ({ totals, status, paymentTerms }) => {
    return (
        <div className="bg-slate-900 dark:bg-black rounded-sm p-8 text-white shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-brand-500/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl"></div>
            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em] mb-8">Financial Summary</h3>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    <div className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">Tax Breakdown</div>
                ...
                <div className="flex justify-between items-end">
                    <div>
                        <span className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Total Payable</span>
