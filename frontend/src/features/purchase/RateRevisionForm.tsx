            ...
            <div className="pt-8 space-y-10 pb-32">
                    ...
                    actions={
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 shadow-sm transition active:scale-95"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 space-y-10">
                        <div className="bg-white dark:bg-slate-800 p-10 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <div className="space-y-8">
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Revision Justification Narrative</label>
                                    <textarea
                                        value={reason}
                                        onChange={e => setReason(e.target.value)}
                                        rows={4}
                                        className="w-full px-8 py-6 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-[2rem] text-xs font-bold focus:ring-4 focus:ring-primary/5 outline-none transition-all resize-none"
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        {selectedBatch ? (
                            <div className="bg-slate-900 p-10 rounded-[3.5rem] text-white shadow-2xl space-y-10 relative overflow-hidden group animate-in fade-in zoom-in-95 duration-700">
                                <div className="absolute -bottom-10 -right-10 opacity-5 group-hover:scale-110 transition-transform duration-1000">
                                    <Calculator className="w-48 h-48" />
                                </div>
                                
                                <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] relative z-10 flex items-center gap-3">
                                ...
                                <div className="space-y-8 relative z-10">
                                    <div className="grid grid-cols-2 gap-8">
                                        <div>
                                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Original Basis</p>
                                    ...
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4">Total Liability Delta</p>
                            ...
                            <div className="bg-white dark:bg-slate-800 p-12 rounded-[3.5rem] border border-dashed border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center opacity-30 grayscale min-h-[400px]">
                        ...
                        <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-4 animate-in slide-in-from-right-10 duration-1000">
