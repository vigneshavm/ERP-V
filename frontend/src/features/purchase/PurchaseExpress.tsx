            ...
            <div className="w-full pt-8 space-y-10 pb-32 animate-in fade-in duration-700">
                <PageHeader 
                    ...
                    actions={
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-900 rounded-sm border border-slate-200 dark:border-slate-800">
                                <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Auto-Print Labels</span>
                                <button 
                                    onClick={() => setAutoPrint(!autoPrint)}
                                    className={`w-10 h-5 rounded-full transition-all relative ${autoPrint ? 'bg-primary' : 'bg-slate-300 dark:bg-slate-700'}`}
                                >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                            <div className="p-10 space-y-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <div className="md:col-span-1 relative group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className={`w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-900 border ${supplierId ? 'border-primary/50' : 'border-transparent'} rounded-[1.5rem] text-xs font-bold focus:ring-4 focus:ring-primary/10 transition-all outline-none uppercase tracking-tighter`}
                                            />
                                            {supplierId && (
                                        ...
                                        {showSupplierDropdown && (
                                            <div 
                                                className="absolute top-full left-0 right-0 mt-4 bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-700 z-50 overflow-hidden animate-in slide-in-from-top-4 duration-300"
                                                    ...
                                                    {reduxSuppliers?.filter(s => s.businessName.toLowerCase().includes(supplierSearch.toLowerCase())).length > 0 ? (
                                                        reduxSuppliers?.filter(s => s.businessName.toLowerCase().includes(supplierSearch.toLowerCase())).map(s => (
                                                            <div 
                                                                ...
                                                                className="px-8 py-5 hover:bg-primary/5 cursor-pointer flex items-center justify-between group/item border-b border-slate-50 dark:border-slate-800 last:border-0"
                                                            >
                                                                <div>
                                                                    <p className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-tighter">{s.businessName}</p>
                                                                    <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest">{s.state || s.city || 'General Node'}</p>
                                                                </div>
                                    ...
                                    <div>
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Invoice Ref #</label>
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-[1.5rem] text-xs font-bold focus:ring-4 focus:ring-primary/10 transition-all outline-none uppercase tracking-tighter"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-[1.5rem] text-xs font-bold focus:ring-4 focus:ring-primary/10 transition-all outline-none"
                                            />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                            <div className="p-10 space-y-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        <div className="p-4 bg-success-soft text-success dark:bg-success-soft rounded-[1.5rem]">
                                ...
                                <div className="space-y-6">
                                    ...
                                    {items.map((item, idx) => (
                                        <div key={item.id} className="grid grid-cols-12 gap-6 items-center p-6 bg-slate-50 dark:bg-slate-900/40 rounded-[2rem] border border-transparent hover:border-primary/20 transition-all group/row animate-in slide-in-from-bottom-2 duration-300">
                                            <div className="col-span-4 relative">
                                                <input 
                                                    ...
                                                    className="w-full bg-transparent border-none text-xs font-black uppercase tracking-tighter placeholder:text-slate-300 focus:ring-0 text-slate-900 dark:text-white"
                                                />
                                                {item.sku && <p className="text-[9px] font-bold text-slate-400 mt-1 uppercase tracking-widest font-mono">SKU: {item.sku}</p>}
                                                
                                                {activeSearchRow === idx && item.product_name && (
                                                    <div className="absolute top-full left-0 right-0 mt-6 bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-700 z-50 max-h-60 overflow-hidden overflow-y-auto custom-scrollbar animate-in zoom-in-95">
                                                        {products.filter(p => p.name.toLowerCase().includes(item.product_name.toLowerCase())).map(p => (
                                                            <div 
                                                                ...
                                                                className="px-8 py-4 hover:bg-primary/5 cursor-pointer flex items-center justify-between border-b border-slate-50 dark:border-slate-800 last:border-0"
                                                            >
                                                                <div>
                                                                    <div className="flex items-center gap-2">
                                                                        <p className="text-[10px] font-black uppercase tracking-tighter text-slate-900 dark:text-white">{p.name}</p>
                                                                        <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-full text-[8px] font-black uppercase text-slate-400 tracking-widest">{p.category}</span>
                                                                    </div>
                                                                    <p className="text-[9px] font-bold text-slate-400 mt-1 font-mono">{p.sku}</p>
                                                                </div>
                                                                <div className="text-right">
                                                                    <p className="text-[10px] font-black text-primary">₹{(p as any).costPrice || (p as any).cost_price || 0}</p>
                                                                    <p className="text-[9px] font-bold text-slate-400 mt-1 uppercase">Stock: {p.stockQty} {p.unit}</p>
                                                                </div>
                                                            </div>
                                                        ))}
                                                    </div>
                                            ...
                                            <div className="col-span-2">
                                                <div className="px-3 py-1 bg-white/50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700 text-center">
                                                    <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest truncate block">
                                                        {item.category || 'Unset'}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="col-span-2 flex items-center gap-2">
                                                <input 
                                                    ...
                                                    className="w-full bg-transparent border-none text-xs font-black text-center focus:ring-0 text-slate-900 dark:text-white"
                                                />
                                            ...
                                            <div className="col-span-2">
                                                <input 
                                                    ...
                                                    className="w-full bg-transparent border-none text-xs font-black text-right focus:ring-0 text-slate-900 dark:text-white tabular-nums"
                                                />
                                            </div>
                                            ...
                                            <div className="col-span-1 flex justify-end">
                                                <button onClick={() => removeItem(idx)} className="p-3 text-slate-300 hover:text-danger hover:bg-danger-soft dark:hover:bg-danger-soft rounded-xl transition-all">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div className="bg-white dark:bg-slate-800 rounded-xl p-10 border border-slate-200 dark:border-slate-700 shadow-sm space-y-6">
                                ...
                                <textarea 
                                    ...
                                    className="w-full h-24 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-[2rem] p-6 text-xs font-bold focus:ring-4 focus:ring-primary/10 outline-none transition-all resize-none"
                                />
                            </div>
                            <div className="bg-white dark:bg-slate-800 rounded-xl p-10 border border-slate-200 dark:border-slate-700 shadow-sm space-y-6 flex flex-col justify-center items-center group cursor-pointer hover:border-primary/20 transition-all">
                                <div className="p-5 bg-slate-50 dark:bg-slate-900 rounded-[2rem] text-slate-400 group-hover:text-primary transition-all">
                                    <Upload className="w-8 h-8" />
                                </div>
                                <div className="text-center">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-900 dark:text-white">Reference Payload</p>
                                    <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest">Upload Invoice Image/PDF</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="xl:col-span-4 space-y-10">
                        <div className="bg-slate-900 dark:bg-slate-950 p-12 rounded-xl text-white shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] space-y-12 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 space-y-12">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Tax (CGST @{(!isInterState && totals.tax > 0) ? '9%' : '0%'})</span>
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Tax (SGST @{(!isInterState && totals.tax > 0) ? '9%' : '0%'})</span>
                                    ...
                                    {isInterState && (
                                        <div className="flex justify-between items-center">
                                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Tax (IGST @18%)</span>
                                ...
                                <div className="space-y-6">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Settlement Strategy</label>
                        ...
                        <div className="p-10 bg-success/5 dark:bg-success/10 border border-success/10 rounded-[3.5rem] space-y-6 animate-pulse hover:animate-none transition-all">
                            <div className="flex items-center gap-4">
