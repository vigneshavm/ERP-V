                        ...
                        <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 p-12 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group border border-white/10">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Aggregate Liability Exposure</p>
                                </div>
                                <h2 className="text-6xl font-black tracking-tighter tabular-nums">₹{totalPayable.toLocaleString('en-IN')}</h2>
                                <p className="text-sm font-bold text-primary/80 mt-6 flex items-center gap-2 italic">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                                <div>
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="p-2.5 bg-danger-soft dark:bg-danger-soft text-danger rounded-xl">
                                ...
                                <button
                                    ...
                                    className="px-8 py-4 bg-danger text-white rounded-sm text-xs font-black uppercase tracking-widest shadow-xl shadow-rose-500/20 hover:bg-danger/90 hover:scale-105 active:scale-95 transition-all"
                                >
                                    Review Ageing Intel
                                </button>
                            </div>
