                    ...
                    {[
                        ...
                        <div key={i} className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm group hover:border-primary/20 transition-all duration-500 overflow-hidden relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter uppercase tabular-nums">{card.val}</p>
                            </div>
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                {loading ? (
                                    ...
                                    filteredRevisions.map((rev) => (
                                        <tr key={rev._id} className="group hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-all cursor-default">
                                            ...
                                            <td className="px-8 py-6">
                                                <p className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none mb-1">{rev.itemId?.name || 'Unknown Entity'}</p>
                                            ...
                                            <td className="px-8 py-6">
                                                <p className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-tighter truncate max-w-[180px]">{rev.supplierId?.businessName}</p>
                                            </td>
                                            <td className="px-8 py-6">
                                                <div className="flex items-center justify-center gap-3">
                                                    <span className="text-[10px] font-black text-slate-400 line-through tabular-nums">₹{rev.oldRate}</span>
                ...
                <div className="flex items-center gap-4 p-8 bg-primary/5 rounded-[2.5rem] border border-primary/10 animate-in zoom-in-95 duration-1000">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-bold text-primary/80 leading-relaxed italic">
                            Authorization of rate revision nodes will automatically initialize institutional <span className="text-slate-900 dark:text-white font-black underline">Debit/Credit Notes</span> and recalibrate real-time inventory cost basis.
                        </p>
                    </div>
                </div>
            </div>
