                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-6 py-3.5 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-sm text-xs font-black uppercase tracking-tighter shadow-sm focus:ring-4 focus:ring-primary/10 outline-none disabled:opacity-30 cursor-pointer"
                                    >
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Reason</label>
                                    <div className="relative">
                                        <select
                                            value={returnData.reason}
                                            onChange={(e) => setReturnData({ ...returnData, reason: e.target.value as ReturnReason })}
                                            className="w-full pl-6 pr-12 py-3.5 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-sm text-xs font-black uppercase tracking-tighter shadow-sm focus:ring-4 focus:ring-rose-500/10 outline-none appearance-none cursor-pointer"
                                        >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-6 py-3.5 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-sm text-xs font-black focus:ring-4 focus:ring-primary/10 outline-none"
                                    />
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr key={idx} className={`group hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-all ${item.return_quantity > 0 ? 'bg-danger/20 dark:bg-danger-soft' : ''}`}>
                                                ...
                                                <td className="px-8 py-6">
                                                    <input
                                                        ...
                                                        className={`w-full text-center py-2.5 bg-slate-100 dark:bg-slate-900 border border-transparent rounded-xl text-xs font-black tabular-nums focus:ring-2 focus:ring-primary/20 outline-none transition-all ${item.return_quantity > 0 ? 'text-primary' : 'text-slate-400'}`}
                                                    />
                                                </td>
                                                <td className="px-8 py-6 text-right">
                                                    <div className="flex items-center justify-end gap-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-24 text-right bg-transparent border-b border-dashed border-slate-300 dark:border-slate-700 py-1 text-xs font-black tabular-nums focus:border-primary outline-none"
                                                        />
                                                    </div>
                                                </td>
                                                <td className="px-8 py-6 text-right">
                                                    <span className="text-sm font-black text-slate-900 dark:text-white tabular-nums tracking-tight">₹{item.line_total.toFixed(2)}</span>
                                                </td>
                                            </tr>
                                        ))}
                    ...
                    <div className="lg:col-span-4 space-y-10">
                        ...
                        <div className="bg-slate-900 dark:bg-slate-900 p-10 rounded-[3.5rem] text-white shadow-2xl space-y-10 relative overflow-hidden group">
                            ...
                            <div className="pt-6 border-t border-white/5 flex items-start gap-4 relative z-10 opacity-60 italic">
                                ...
                                <p className="text-[10px] font-black leading-relaxed text-slate-400">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-3 bg-slate-50 dark:bg-slate-900 border border-transparent rounded-sm text-xs font-black uppercase tracking-widest focus:ring-4 focus:ring-primary/10 outline-none transition-all"
                                    />
                                </div>
                            </div>
                        </div>
