        ...
        actions={
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-slate-900 dark:bg-primary text-white rounded-xl text-sm font-bold shadow-lg shadow-indigo-200 dark:shadow-none hover:bg-primary-hover active:scale-95 transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-bold text-success dark:text-success uppercase tracking-wide">Total Paid</span>
          </div>
          <span className="text-3xl font-black text-slate-900 dark:text-white">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-1">
            <div className="p-1.5 rounded-lg bg-danger-soft dark:bg-danger/10 text-danger dark:text-danger">
              <ArrowUpRight className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-danger dark:text-danger uppercase tracking-wide">Outstanding Balance</span>
          </div>
          <span className="text-3xl font-black text-slate-900 dark:text-white">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="number"
                  autoFocus
                  className="w-full text-xl font-bold p-3 rounded-xl border-2 border-primary/30 focus:border-primary outline-none bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white transition-all"
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary-hover shadow-lg shadow-indigo-200 dark:shadow-none transition-colors"
                >
                  Save Changes
                </button>
              </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-sm border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
            ...
            <div className="p-5 space-y-4">
              {/* Reliability Widget */}
              <div className="p-4 bg-success-soft dark:bg-success/10 border border-success/50 dark:border-success/20 rounded-xl group hover:bg-success/30 dark:hover:bg-success/15 transition-all cursor-pointer">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <div className="p-1.5 bg-success rounded-lg text-white">
                      <ShieldCheck className="w-3.5 h-3.5" />
                    </div>
                    <span className="text-[11px] font-bold uppercase tracking-wider text-success">Reliability Score</span>
                  </div>
                </div>
              ...
              <button
                ...
                className="w-full py-3 mt-2 bg-primary-soft dark:bg-primary/10 text-primary dark:text-primary rounded-xl text-[10px] font-black uppercase tracking-[0.2em] border border-primary/30 dark:border-primary/20 hover:bg-primary-soft dark:hover:bg-primary/20 transition-all"
              >
                Generate Ledger
              </button>
            </div>
