...
const BatchPriceUpdate: React.FC = () => {
    ...
    return (
        <div className="p-6 w-full">
            <div className="mb-8">
                <h1 className="page-title text-slate-800 dark:text-white flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 gap-6">
                    ...
                    <form onSubmit={handleScan} className="flex gap-4">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
                            />
                        </div>
                        <button
                            type="submit"
                ...
                {item && (
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg border-2 border-success/20 animation-fade-in">
                        <div className="flex items-start justify-between mb-6">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white">{item.name}</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                                    SKU: <span className="font-mono bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded">{item.sku}</span>
                                </p>
                            </div>
                            <div className="text-right">
                                <div className="text-sm text-slate-500 dark:text-slate-400">Current Stock</div>
                                <div className="text-2xl font-bold text-slate-800 dark:text-white flex items-center justify-end gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end bg-slate-50 dark:bg-slate-900/50 p-6 rounded-xl">
                            <div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="w-full text-2xl font-bold text-slate-900 dark:text-white bg-white dark:bg-slate-800 border-2 border-success rounded-lg px-4 py-3 focus:outline-none focus:ring-4 focus:ring-emerald-500/20"
                                />
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex justify-end gap-4">
                            <button
                                ...
                                className="px-6 py-3 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg font-medium transition-colors"
                            >
                                Cancel
                            </button>
                            <button
