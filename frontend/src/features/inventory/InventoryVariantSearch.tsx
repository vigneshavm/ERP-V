        ...
        <div className="p-6 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm space-y-6">
                <form onSubmit={handleSearch} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-1.5 ml-1">
                            Product / Item Name
                        </label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm font-bold text-slate-900 dark:text-white transition-all"
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 outline-none focus:ring-2 focus:ring-primary/20"
                            >
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                        <button
                            ...
                            className="px-4 py-2.5 text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-xl flex items-center gap-2 transition-all border border-slate-200 dark:border-slate-700"
                        >
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden shadow-sm">
                ...
                {isLoading ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <h4 className="text-base font-bold text-slate-800 dark:text-slate-200">Couldn't load inventory</h4>
                        <p className="text-xs text-slate-500 mt-1 mb-4">{loadError}</p>
                        <button
                    ...
                    <div className="p-12 text-center">
                        ...
                        <h4 className="text-base font-bold text-slate-800 dark:text-slate-200">No matching inventory found</h4>
                        <p className="text-xs text-slate-500 mt-1">Try adjusting your size, brand, color, or shelf filters.</p>
                    </div>
                ) : (
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-slate-50 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-700">
                                <tr>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Product</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Brand</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Size</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Color</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Shelf Code</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Shelf Type</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Available Qty</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Status</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-200 dark:divide-slate-700/60">
                                {items.map((item, idx) => {
                                    ...
                                    return (
                                        <tr key={item._id || item.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-xs font-bold text-slate-700 dark:text-slate-300">
                                                {brand || <span className="text-slate-400 font-medium">—</span>}
                                            </td>
                                            <td className="px-6 py-4 text-center">
                                                {size ? (
                                                    <span className="px-2.5 py-1 bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-md text-xs font-black">
                                                        {size}
                                                    </span>
                                            ...
                                            <td className="px-6 py-4 text-center font-mono text-xs font-bold text-slate-800 dark:text-slate-200">
                                                {shelf || <span className="text-slate-400 font-medium">—</span>}
                                            </td>
                                            <td className="px-6 py-4 text-center">
                                                {type ? (
