...
const TenantManager = lazy(() => import('../components/TenantManager.tsx'));
const SuperAdminGrowthConsole = lazy(() => import('../components/GrowPlatform/Architecture/SuperAdminGrowthConsole.tsx'));
