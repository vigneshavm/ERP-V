...
const initialSettingsState: SettingsState = {
  ...
  rolePermissions: {
    [DbRoleCode.OWNER]: ['DASHBOARD', 'PROFIT_PULSE', 'POS', 'INVENTORY', 'PURCHASE', 'VENDORS', 'VENDOR_FORM', 'AGED_STOCK', 'FINANCE', 'SALES', 'DAILY', 'LABOR', 'STOREFRONT', 'SETTINGS', 'REPORTS', 'GROW', 'SYNC_SHARE', 'RESTORE', 'BARCODE', 'BULK_IMPORT', 'DATA_EXPORT'],
    [DbRoleCode.ADMIN]: ['DASHBOARD', 'PROFIT_PULSE', 'POS', 'INVENTORY', 'PURCHASE', 'VENDORS', 'VENDOR_FORM', 'AGED_STOCK', 'FINANCE', 'SALES', 'DAILY', 'LABOR', 'STOREFRONT', 'SETTINGS', 'REPORTS', 'GROW', 'SYNC_SHARE', 'RESTORE', 'BARCODE', 'BULK_IMPORT', 'DATA_EXPORT'],
    [DbRoleCode.MANAGER]: ['DASHBOARD', 'PROFIT_PULSE', 'POS', 'INVENTORY', 'PURCHASE', 'VENDORS', 'VENDOR_FORM', 'AGED_STOCK', 'FINANCE', 'SALES', 'DAILY', 'LABOR', 'STOREFRONT', 'REPORTS', 'SYNC_SHARE', 'BARCODE', 'DATA_EXPORT'],
