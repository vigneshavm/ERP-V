...
export const POSProductBrowser: React.FC<POSProductBrowserProps> = ({ products, currentBranch, currentSector }) => {
    ...
    const filteredProducts = useFuzzySearch<Product>(baseFilteredProducts, ['name', 'sku', 'barcode'], searchQuery);
