...
import { Plus, Search, Filter, FilterX, Receipt, Clock, CheckCircle2, XCircle, MoreVertical, Building2, UserCircle, CreditCard, Landmark, Wallet } from 'lucide-react';
                                        ...
                                        <tr key={expense.id} className="group hover:bg-neutral-50 transition-colors">
                                            ...
                                            <td className="p-6 text-right">
                                                <button
                                                    ...
                                                    className="p-2 text-neutral-400 hover:text-primary hover:bg-neutral-100 dark:hover:bg-neutral-900 rounded-lg opacity-0 group-hover:opacity-100 transition-all"
                                                >
