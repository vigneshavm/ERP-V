    ...
    if (!isOwnerOrAdmin) {
        return (
            <div className="flex flex-col items-center justify-center h-96 text-center">
                ...
                <p className="text-slate-500">Only Owners and Admins can access the Restore Management module.</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 dark:text-white">Restore Management</h1>
                    <p className="text-slate-500 mt-1">Recover your data from previous backups safely and securely.</p>
                </div>
                                            ...
                                            <td className="p-5">
                                                {backup.isCompatible ? (
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-red-500 mt-1 max-w-[200px]">{backup.incompatibleReason}</p>
                                                    </div>
                                                )}
                                            </td>
                                            <td className="p-5">
