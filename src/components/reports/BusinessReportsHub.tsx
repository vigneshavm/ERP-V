    ...
    return (
        <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <StatCard label="Closing Cash" value={`₹${day_book.closing_cash.toLocaleString()}`} isPositive={day_book.closing_cash >= day_book.opening_cash} change={day_book.closing_cash >= day_book.opening_cash ? `+₹${day_book.closing_cash - day_book.opening_cash}` : `-₹${day_book.opening_cash - day_book.day_book_closing_cash}`} />
