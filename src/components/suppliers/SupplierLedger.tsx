    ...
    const vendorLedgers: SupplierLedgerData[] = useMemo(() => {
        return vendors.map(vendor => {
            ...
            const vendorOrders = orders
                .filter(o => o.vendorId === vendor.id && o.sector === currentSector && o.status === 'APPROVED')
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-neutral-500 text-sm mt-1">View transaction history and balances for each supplier</p>
                </div>
