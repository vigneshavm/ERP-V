        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 print:hidden">
                <div>
                    ...
                    <p className="text-neutral-500 text-sm mt-1">Generate and send account statements to suppliers</p>
                </div>
            </div>
                        ...
                        <div className="bg-neutral-50 dark:bg-neutral-700/50 p-4 rounded-lg print:bg-gray-100">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium text-error">₹{statementData.transactions.filter(t => t.credit > 0).reduce((a, t) => a + t.credit, 0).toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                    <span className="text-neutral-600 dark:text-neutral-400">Total Payments:</span>
                                    <span className="font-medium text-success">₹{statementData.transactions.filter(t => t.debit > 0).reduce((a, t) => a + t.debit, 0).toLocaleString()}</span>
                                </div>
