...
export const getMockUser = (req: Request, res: Response) => {
    res.json({
        id: 'u1',
...
export const getMockTransactions = (req: Request, res: Response) => {
    res.json([
        { 
...
export const getMockAnalytics = (req: Request, res: Response) => {
    res.json({
        totalIncome: 154000,
        totalExpense: 92400,
        savingsRate: 40,
