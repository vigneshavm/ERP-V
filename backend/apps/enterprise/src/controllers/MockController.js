...
export const getMockSalesOrders = (req, res) => {
    res.json([
        {
            _id: 'so1',
...
export const getMockDailyAttendance = (req, res) => {
    res.json({
        success: true,
        data: [] // Start with empty for the date
    });
};
export const markAttendanceMock = (req, res) => {
    res.json({
        success: true,
        message: 'Attendance marked successfully (API Mock)'
    });
};
export const getMockExpenseReport = (req, res) => {
    res.json({
...
export const getMockAdvances = (req, res) => {
    ...
    const targetEmpId = employeeId || req.query.employeeId;
    const filtered = targetEmpId
        ? advances.filter(a => a.employeeId === targetEmpId)
        : advances;
    res.json({ success: true, data: filtered });
};
export const getMockLeaves = (req, res) => {
    const { employeeId } = req.params;
    const leaves = [
...
export const getMockHolidays = (req, res) => {
    res.json({
        success: true,
        data: [
...
export const getMockSalaryComponents = (req, res) => {
    res.json({
        success: true,
        data: [
...
export const getMockSalaryStructures = (req, res) => {
    const { employeeId } = req.params;
    const structures = [
...
export const getMockPayrollRuns = (req, res) => {
    const { id } = req.params;
    const runs = [
...
export const getMockAttendanceSummary = (req, res) => {
