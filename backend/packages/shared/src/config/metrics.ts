 ...
 * 
 * Setup:
 * 1. Install: npm install prom-client @types/prom-client
 * 2. Add metrics endpoint: GET /metrics
 */

//  - prom-client types may not be installed
...
// Error counter
export const errorCounter: Counter<string> = new promClient.Counter({
...
// Business metrics
export const invoiceCreated: Counter<string> = new promClient.Counter({
...
export const salesAmount: Counter<string> = new promClient.Counter({
...
export const databaseConnections: Gauge<string> = new promClient.Gauge({
...
// Cache metrics
export const cacheHits: Counter<string> = new promClient.Counter({
    name: 'cache_hits_total',
    help: 'Total number of cache hits',
    registers: [register],
});

export const cacheMisses: Counter<string> = new promClient.Counter({
    name: 'cache_misses_total',
    help: 'Total number of cache misses',
    registers: [register],
});

// Extended Request type for route info
 ...
 */
export const metricsMiddleware = (req: RouteRequest, res: Response, next: NextFunction): void => {
