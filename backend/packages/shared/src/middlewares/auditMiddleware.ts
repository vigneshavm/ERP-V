...
export const logAudit = async ({
    ...
    try {
        ...
        logError("Audit log failed:", error as any);
    }
};
 ...
 */
export const auditDelete = (entityType: string, action: string) => {
 ...
 */
export const auditUpdate = (entityType: string, action: string) => {
    return async (req: Request, res: Response, next: NextFunction) => {
        const originalJson = res.json.bind(res);
