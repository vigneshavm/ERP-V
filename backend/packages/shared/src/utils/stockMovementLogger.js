 ...
 */
export const logStockMovement = async (item, type, quantity, sourceId, sourceType, userId, previousState, newState) => {
    try {
        ...
        info(`Stock movement logged: ${type} | Item: ${item.name} | Qty: ${quantity} | Source: ${sourceType}:${sourceId}`);
    }
    catch (err) {
