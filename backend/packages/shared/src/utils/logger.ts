...
interface LoggerWithStream extends Omit<winston.Logger, "stream"> {
    stream?: {
...
}) as unknown as LoggerWithStream;
 ...
 */
export const logWithContext = (req: Request, level: string, message: string, meta: object = {}) => {
    const contextMeta = {
        ...meta,
