...
const cashbankTransactionSchema = new Schema<ICashbankTransaction>(
    {
        type: {
            type: String,
...
const CashbankTransaction = mongoose.model<ICashbankTransaction>("CashbankTransaction", cashbankTransactionSchema);
