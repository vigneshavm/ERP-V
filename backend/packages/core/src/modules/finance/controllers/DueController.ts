...
// Legacy stubs
export const addDue = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented - use createDueAdjustment instead' });
});

export const getAllDues = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented - use getDueAdjustments instead' });
});

export const getCustomerDues = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented - use getCustomerDueAdjustments instead' });
});

export const updateDue = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented' });
});

export const clearDue = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented' });
});
