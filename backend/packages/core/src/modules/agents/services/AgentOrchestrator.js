...
export class AgentOrchestrator {
     ...
     */
    static async runWorkflow(receiptBuffer, mimeType, tenantId, userId, receiptUrl) {
        ...
        try {
            ...
            const finalMessage = await CommunicationAgent.executeFinalAction(extractedData, auditResult, tenantId, userId, receiptUrl);
