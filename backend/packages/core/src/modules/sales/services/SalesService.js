...
let SalesService = class SalesService {
    ...
    async invalidateSalesCache(userId) {
    ...
    async markAsPaid(invoiceId, userId, userName, paymentData) {
...
SalesService = __decorate([
    injectable(),
    __param(0, inject(InvoiceRepository)),
    __param(1, inject(CustomerRepository)),
    __metadata("design:paramtypes", [InvoiceRepository,
        CustomerRepository])
], SalesService);
export { SalesService };
