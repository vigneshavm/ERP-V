...
import { createReturn, getAllReturns, getReturnById, deleteReturn, } from "../controllers/ReturnController.js";
...
router.delete("/:id", protect, requirePermission("delete:return"), auditDelete("Return", "DELETE_RETURN"), deleteReturn);
