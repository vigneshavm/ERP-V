 ...
 */
export const getSalesInvoiceSummary = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const { tenantId } = req;
 ...
 */
export const getAllSalesInvoices = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getSalesInvoiceById = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const deleteSalesInvoice = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    // Validate ObjectId format
    if (!mongoose.Types.ObjectId.isValid(req.params.id as string)) {
        res.status(400).json({ message: 'Invalid invoice ID format' });
        return;
 ...
 */
export const markSalesInvoiceAsPaid = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const { id } = req.params;
