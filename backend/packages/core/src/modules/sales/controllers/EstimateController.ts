 ...
 */
export const createEstimate = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getAllEstimates = asyncHandler(async (_req: Request, res: Response): Promise<void> =>{
 ...
 * @access Private
 */
export const getEstimateById = asyncHandler(async (req: Request, res: Response): Promise<void> =>{
 ...
 * @access Private
 */
export const deleteEstimate = asyncHandler(async (req: Request, res: Response): Promise<void> =>{
    if (!mongoose.Types.ObjectId.isValid(req.params.id as string)) {
        res.status(400).json({ message: 'Invalid estimate ID format' });
        return;
    }
