 ...
 */
export const createPaymentIn = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const {
            customerId,
            paymentMethods,
        ...
        error(`Create Payment In Error: ${(err as Error).message}`);
 ...
 */
export const getPaymentInRecords = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        ...
        error(`Get Payment In Records Error: ${(err as Error).message}`);
        res.status(500).json({ message: 'Server Error', error: (err as Error).message });
    }
};
 ...
 */
export const getPaymentInById = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        ...
        error(`Get Payment In By ID Error: ${(err as Error).message}`);
        res.status(500).json({ message: 'Server Error', error: (err as Error).message });
    }
};
 ...
 */
export const getCustomerOutstandingInvoices = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        ...
        error(`Get Customer Outstanding Invoices Error: ${(err as Error).message}`);
        res.status(500).json({ message: 'Server Error', error: (err as Error).message });
    }
};
 ...
 */
export const getCustomerPaymentInfo = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const { customerId } = req.params;
        ...
        error(`Get Customer Payment Info Error: ${(err as Error).message}`);
        res.status(500).json({ message: 'Server Error', error: (err as Error).message });
    }
};
