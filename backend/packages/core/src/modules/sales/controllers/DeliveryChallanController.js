        ...
        if (salesOrderId && mongoose.Types.ObjectId.isValid(salesOrderId)) {
            ...
            if (salesOrder) {
                ...
                for (const challanItem of validatedItems) {
                    ...
                    await logStock(item, 'DELIVER', challanItem.deliveredQty, challan._id, 'DeliveryChallan', req.user._id, previousState, newState);
                    await logStock(item, 'IN_TRANSIT', challanItem.deliveredQty, challan._id, 'DeliveryChallan', req.user._id, previousState, newState);
                }
