 ...
 */
export const createReturn = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const {
        invoiceId,
        items,
        refundMethod = 'credit',
 ...
 */
export const getAllReturns = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getReturnById = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    // Validate ObjectId format
 ...
 */
export const deleteReturn = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    // Validate ObjectId format
    if (!mongoose.Types.ObjectId.isValid(req.params.id as string)) {
        res.status(400).json({ message: 'Invalid return ID format' });
        return;
