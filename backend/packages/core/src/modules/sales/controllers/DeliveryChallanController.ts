 ...
 */
export const createDeliveryChallan = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getAllDeliveryChallans = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getDeliveryChallanById = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const updateDeliveryChallan = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    if (!mongoose.Types.ObjectId.isValid(req.params.id as string)) {
        res.status(400).json({ message: 'Invalid challan ID' });
        return;
    }
 ...
 */
export const convertToInvoice = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    // Validate user is authenticated
    if (!req.user || !req.user._id) {
        res.status(401).json({ message: 'User not authenticated' });
        return;
 ...
 */
export const deleteDeliveryChallan = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    if (!mongoose.Types.ObjectId.isValid(req.params.id as string)) {
        res.status(400).json({ message: 'Invalid challan ID' });
        return;
    }
