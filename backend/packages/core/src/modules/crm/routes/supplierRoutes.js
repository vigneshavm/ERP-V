...
import { getSupplierAnalytics, getSupplierReports, getAgeingAnalysis, bulkUpdateOpeningBalance, getVendorInflowOutflow, getSupplierLedger, } from '../../purchase/controllers/SupplierController.js';
const router = Router();
