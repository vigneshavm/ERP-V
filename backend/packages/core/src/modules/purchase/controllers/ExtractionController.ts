 ...
 */
export const extractSupplierFromInvoice = asyncHandler(async (req: Request, res: Response) =>{
    if (!req.file) {
 ...
 */
export const extractSupplierFromText = asyncHandler(async (req: Request, res: Response) =>{
 ...
 */
export const extractPurchaseInvoice = asyncHandler(async (req: Request, res: Response) =>{
    if (!req.file) {
        return res.status(400).json({ success: false, message: 'No invoice file uploaded' });
    }
