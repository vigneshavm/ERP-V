 ...
 */
export const createPurchase = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getAllPurchases = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const query: any = {};
 ...
 */
export const getPurchaseById = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
...
export const getSupplierTotals = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getPurchaseHistory = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
