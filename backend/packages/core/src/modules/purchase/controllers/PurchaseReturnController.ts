...
export const createPurchaseReturn = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const {
        billId,
        supplierId,
        items,
 ...
 */
export const getAllPurchaseReturns = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const getPurchaseReturnById = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
 ...
 */
export const deletePurchaseReturn = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> =>{
    const { id } = req.params;
