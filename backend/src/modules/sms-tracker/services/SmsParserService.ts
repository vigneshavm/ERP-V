...
export class SmsParserService {
     ...
     */
    public static parse(text: string, sender: string): ParsedSMS {
    ...
    private static categorize(merchant: string, text: string): string {
    ...
    private static identifyBank(sender: string, text: string): string {
