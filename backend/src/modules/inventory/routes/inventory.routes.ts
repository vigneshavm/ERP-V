...
router.get("/reports/stock-status", protect, inventoryController.getStockStatusReport);
router.get("/reports/low-stock", protect, inventoryController.getLowStockReport);
router.get("/reports/dead-stock", protect, inventoryController.getDeadStockReport);
router.get("/reports/stock-filters", protect, inventoryController.getStockFilterOptions);
...
router.get("/stock-age", protect, inventoryController.getStockAgeBuckets);
