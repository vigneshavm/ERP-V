...
export const getPurchaseTrends = async (tenantId: string) => {
...
export const getCashFlowForecast = async (tenantId: string) => {
...
export const getProfitabilityAnalysis = async (tenantId: string) => {
...
export const getOverdueList = async (tenantId: string) => {
    const today = new Date();
