 ...
 */
export const validateStockLevels = (item: any) => {
    if (item.stockQty < 0) {
 ...
 * @throws {Error} If validation fails
 */
export const validateSalesOrderQuantities = (salesOrder: any) => {
 ...
 */
export const validateInventoryConstraints = (item: any, salesOrder: any = null) => {
