...
export const addDue = async (req: Request, res: Response): Promise<void> => {
...
export const getCustomerDues = async (req: Request, res: Response): Promise<void> => {
    res.status(501).json({ message: 'Not implemented - use getCustomerDueAdjustments instead' });
};

export const updateDue = async (req: Request, res: Response): Promise<void> => {
