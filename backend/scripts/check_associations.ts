...
const run = async () => {
    try {
        ...
        console.log(`Found ${suppliers.length} suppliers in Default Organization.`);
        ...
        for (const s of suppliers) {
            ...
            console.log(`Supplier: ${s.businessName} (${s._id})`);
