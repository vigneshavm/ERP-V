...
export const MOCK_DATABASE: MockDatabase = {
    '1': { // Big Bazaar
        ...
        cheques: [],
        salesHistory: [
            { id: 'inv-003', date: subDays(1), total: 130, customerId: 'c1', sector: 'General', branchId: 'br-bb-mdu-01', paymentMethod: 'CASH', taxMode: 'INCLUSIVE', items: [] } // Items would need deep copy of products, keeping empty for brevity or manual reconstruction if needed.
        ],
        purchaseOrders: [],
        laborPayments: [
    ...
    '3': { // Reliance Digital
        ...
        salesHistory: [
            { id: 'inv-002', date: subDays(0), total: 79900, customerId: 'c3', sector: 'Electronics', branchId: 'br-rel-chn-01', paymentMethod: 'CARD', taxMode: 'EXCLUSIVE', items: [] },
            { id: 'inv-004', date: subDays(2), total: 24900, customerId: 'c4', sector: 'Electronics', branchId: 'br-rel-chn-01', paymentMethod: 'UPI', taxMode: 'INCLUSIVE', items: [] }
        ],
        purchaseOrders: [
    ...
    '6': { // Pothys
        ...
        salesHistory: [
            { id: 'inv-001', date: subDays(0), total: 4698, customerId: 'c2', sector: 'Textile', branchId: 'br-po-chn-01', paymentMethod: 'UPI', taxMode: 'INCLUSIVE', items: [] }
        ],
        purchaseOrders: [
