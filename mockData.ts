...
import { Product, Sale, Customer, Transaction, Cheque, Employee, PurchaseOrder, LaborPayment, TransactionType } from './types';
...
export const MOCK_EMPLOYEES: Employee[] = [
    { id: 'admin1', name: 'Admin (Testing)', role: 'App Owner', dailyRate: 2000, sector: 'General', branch: 'Alpha', systemRole: 'Owner', pin: '9999' },
    { id: 'e1', name: 'Ramesh (Manager)', role: 'Store Manager', dailyRate: 1500, sector: 'Textile', branch: 'Alpha', systemRole: 'Manager', pin: '1234' },
    { id: 'e2', name: 'Suresh (Sales)', role: 'Sales Executive', dailyRate: 800, sector: 'Textile', branch: 'Alpha', systemRole: 'Staff', pin: '0000' },
    { id: 'e3', name: 'Anita (Cashier)', role: 'Cashier', dailyRate: 900, sector: 'Electronics', branch: 'Beta', systemRole: 'Staff', pin: '1111' },
    { id: 'e4', name: 'Vikram (Helper)', role: 'Helper', dailyRate: 500, sector: 'General', branch: 'Gamma', systemRole: 'Staff', pin: '2222' }
];

// --- Finance Mock ---
export const MOCK_TRANSACTIONS: Transaction[] = [
    { id: 't1', type: TransactionType.EXPENSE, category: 'Rent', amount: 25000, date: subDays(1), description: 'Shop Rent - Alpha', sector: 'Textile', branch: 'Alpha' },
    { id: 't2', type: TransactionType.EXPENSE, category: 'Utility', amount: 4500, date: subDays(2), description: 'Electricity Bill', sector: 'Textile', branch: 'Alpha' },
    { id: 't3', type: TransactionType.INCOME, category: 'Sales', amount: 45000, date: subDays(0), description: 'Daily Sales Cash Deposit', sector: 'Textile', branch: 'Alpha' },
    { id: 't4', type: TransactionType.EXPENSE, category: 'Inventory', amount: 150000, date: subDays(5), description: 'Samsung Stock Payment', sector: 'Electronics', branch: 'Beta' },
    { id: 't5', type: TransactionType.EXPENSE, category: 'Marketing', amount: 5000, date: subDays(10), description: 'Local Flyers', sector: 'General', branch: 'Gamma' }
];
